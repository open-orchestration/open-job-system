[Skip to main content](https://firebase.google.com/docs/extensions#main-content)

[![Firebase](https://www.gstatic.com/devrel-devsite/prod/v8b2f8e7f8a7704cc38c0519ef05e8f889c427cc26f7c8f743e84df2a01b1dee7/firebase/images/lockup.svg)](https://firebase.google.com/)
...
- [SQL Connect](https://firebase.google.com/products/sql-connect)
...
- [English](https://firebase.google.com/docs/extensions)
- [Deutsch](https://firebase.google.com/docs/extensions?hl=de)
- [Español – América Latina](https://firebase.google.com/docs/extensions?hl=es-419)
- [Français](https://firebase.google.com/docs/extensions?hl=fr)
- [Indonesia](https://firebase.google.com/docs/extensions?hl=id)
- [Italiano](https://firebase.google.com/docs/extensions?hl=it)
- [Polski](https://firebase.google.com/docs/extensions?hl=pl)
- [Português – Brasil](https://firebase.google.com/docs/extensions?hl=pt-br)
- [Tiếng Việt](https://firebase.google.com/docs/extensions?hl=vi)
- [Türkçe](https://firebase.google.com/docs/extensions?hl=tr)
- [Русский](https://firebase.google.com/docs/extensions?hl=ru)
- [עברית](https://firebase.google.com/docs/extensions?hl=he)
- [العربيّة](https://firebase.google.com/docs/extensions?hl=ar)
- [فارسی](https://firebase.google.com/docs/extensions?hl=fa)
- [हिंदी](https://firebase.google.com/docs/extensions?hl=hi)
- [বাংলা](https://firebase.google.com/docs/extensions?hl=bn)
- [ภาษาไทย](https://firebase.google.com/docs/extensions?hl=th)
- [中文 – 简体](https://firebase.google.com/docs/extensions?hl=zh-cn)
- [中文 – 繁體](https://firebase.google.com/docs/extensions?hl=zh-tw)
- [日本語](https://firebase.google.com/docs/extensions?hl=ja)
- [한국어](https://firebase.google.com/docs/extensions?hl=ko)

[Blog](https://firebase.blog/) [Go to console](https://console.firebase.google.com/)

[Sign in](https://firebase.google.com/_d/signin?continue=https%3A%2F%2Ffirebase.google.com%2Fdocs%2Fextensions&prompt=select_account)
...
\\
\\
Access agentive development tools, like our agent skills and MCP server.](https://firebase.google.com/docs/ai-assistance/agent-skills)
...
\\
\\
Build genAI features and securely access Gemini models directly from your mobile & web apps.](https://firebase.google.com/docs/ai-logic)
...
\\
\\
Build and scale your apps using a fully-managed PostgreSQL relational database service.](https://firebase.google.com/docs/sql-connect)
- [Firestore\\
\\
\\
...
- Authentication
  ...
  - [Configure Auth providers using the Firebase CLI](https://firebase.google.com/docs/auth/configure-providers-cli)
...
- Phone Number Verification
  ...
  - [Codelab](https://firebase.google.com/codelabs/firebase-pnv-android)
  - [Get started on Android](https://firebase.google.com/docs/phone-number-verification/android/get-started)
  - [Upgrade to production](https://firebase.google.com/docs/phone-number-verification/android/production-mode)
  - [Verify tokens on your server](https://firebase.google.com/docs/phone-number-verification/verify-tokens)
...
- SQL Connect
  ...
  - [Introduction](https://firebase.google.com/docs/sql-connect)
  - [Pricing and billing](https://firebase.google.com/docs/sql-connect/pricing)
  - [Get started](https://firebase.google.com/docs/sql-connect/quickstart)
  - [Get started with AI agents](https://firebase.google.com/docs/sql-connect/quickstart-ai)
  - Quickstarts

  - [Android](https://firebase.google.com/docs/sql-connect/quickstart/android)
  - [React](https://firebase.google.com/docs/sql-connect/quickstart/react)
  - [Flutter](https://firebase.google.com/docs/sql-connect/quickstart/flutter)
  - Design schemas and operations

  - [Design SQL Connect schemas](https://firebase.google.com/docs/sql-connect/schemas-guide)
  - [Implement SQL Connect queries](https://firebase.google.com/docs/sql-connect/queries-guide)
  - [Implement SQL Connect mutations](https://firebase.google.com/docs/sql-connect/mutations-guide)
  - [Secure operations with authorization](https://firebase.google.com/docs/sql-connect/authorization-and-security)
  - [Implement operations using native SQL](https://firebase.google.com/docs/sql-connect/native-sql)
  - Develop and test with SQL Connect

  - [Seed test data and perform bulk operations](https://firebase.google.com/docs/sql-connect/data-seeding-bulk-operations)
  - [Generate Web SDKs](https://firebase.google.com/docs/sql-connect/web-sdk)
  - [Generate Android SDKs](https://firebase.google.com/docs/sql-connect/android-sdk)
  - [Generate iOS SDKs](https://firebase.google.com/docs/sql-connect/ios-sdk)
  - [Generate Flutter SDKs](https://firebase.google.com/docs/sql-connect/flutter-sdk)
  - [Get real-time updates](https://firebase.google.com/docs/sql-connect/realtime)
  - [Generate Admin SDKs](https://firebase.google.com/docs/sql-connect/generate-admin-sdk)
  - [Use the SQL Connect emulator for CI/CD](https://firebase.google.com/docs/sql-connect/data-connect-emulator-suite)
  - Manage SQL Connect projects

  - [Manage schemas and connectors](https://firebase.google.com/docs/sql-connect/manage-schemas-and-connectors)
  - [Manage services and databases](https://firebase.google.com/docs/sql-connect/manage-services-and-databases)
  - [Run privileged operations with the Firebase Admin SDK](https://firebase.google.com/docs/sql-connect/admin-sdk)
  - SQL Connect solutions

  - [Use AI assistance for schemas, queries and mutations](https://firebase.google.com/docs/sql-connect/ai-assistance)
  - [Extend with Cloud Functions](https://firebase.google.com/docs/sql-connect/extend-data-connect-with-functions)
  - [Extend data source support with custom resolvers](https://firebase.google.com/docs/sql-connect/custom-resolvers)
  - [Perform vector similarity search](https://firebase.google.com/docs/sql-connect/solutions-vector-similarity-search)
  - [Perform full-text search](https://firebase.google.com/docs/sql-connect/solutions-full-text-search)
  - GraphQL language reference guides

  - [Directives reference](https://firebase.google.com/docs/reference/sql-connect/gql/directive)
  - [Queries reference](https://firebase.google.com/docs/reference/sql-connect/gql/query)
  - [Mutations reference](https://firebase.google.com/docs/reference/sql-connect/gql/mutation)
  - [Objects reference](https://firebase.google.com/docs/reference/sql-connect/gql/object)
  - [Input objects reference](https://firebase.google.com/docs/reference/sql-connect/gql/input_object)
  - [Scalars reference](https://firebase.google.com/docs/reference/sql-connect/gql/scalar)
  - [Enums reference](https://firebase.google.com/docs/reference/sql-connect/gql/enum)
  - Additional reference guides

  - [CLI reference](https://firebase.google.com/docs/sql-connect/cli-reference)
  - [SQL Connect configuration file reference](https://firebase.google.com/docs/sql-connect/configuration-reference)
  - [IAM configuration for SQL Connect projects](https://firebase.google.com/docs/sql-connect/iam-configuration)
  - [Common Expression Language (CEL) reference](https://firebase.google.com/docs/sql-connect/cel-reference)
  - [Cloud Audit Logging reference](https://firebase.google.com/docs/sql-connect/cloud-audit-logging)
...
- Cloud Firestore
  ...
  - Monitor and troubleshoot
    ...
    - [View Knowledge Catalog insights](https://firebase.google.com/docs/firestore/knowledge-catalog)
  ...
  - Native mode with Core and Pipeline operations
    ...
    - Manage data
      ...
      - [Data contention in transaction](https://firebase.google.com/docs/firestore/enterprise/transaction-data-contention)
      - Indexing data
      ...
      - Query data with Firestore Pipeline operations
        ...
        - [Get started with Pipeline operations](https://firebase.google.com/docs/firestore/pipelines/get-started-with-pipelines)
        - [Perform joins with subqueries](https://firebase.google.com/docs/firestore/pipelines/perform-joins-with-sub-pipelines)
        - Functions
      ...
      - [Modify data with Firestore Pipeline operations](https://firebase.google.com/docs/firestore/pipelines/dml)
      - [Use text search with Firestore Pipeline operations](https://firebase.google.com/docs/firestore/enterprise/text-search)
      - [Use geospatial queries with Firestore Pipeline operations](https://firebase.google.com/docs/firestore/enterprise/geospatial-query)
      - Delete data
    ...
    - Usage, locations, and pricing
      ...
      - [Analyze usage insights](https://firebase.google.com/docs/firestore/enterprise/usage-insights)
      - Pricing
    ...
    - Monitor and troubleshoot
      ...
      - [View Knowledge Catalog insights](https://firebase.google.com/docs/firestore/enterprise/knowledge-catalog)
  ...
  - Firestore with MongoDB compatibility
    ...
    - Manage data
      ...
      - [Read real-time data with change streams](https://firebase.google.com/docs/firestore/enterprise/change-streams)
      - Data behaviour and lifecycle management
      ...
      - [Use text search](https://firebase.google.com/docs/firestore/enterprise/text-search-mongodb)
      - [Use geospatial queries](https://firebase.google.com/docs/firestore/enterprise/geo-query-mongodb)
      - Use saved queries



        - [Overview](https://firebase.google.com/docs/firestore/enterprise/saved-queries-mongodb)
        - [Create and manage saved queries](https://firebase.google.com/docs/firestore/enterprise/create-manage-saved-queries-mongodb)
    ...
    - Usage, locations, and pricing
      ...
      - [Analyze usage insights](https://firebase.google.com/docs/firestore/enterprise/usage-insights-mongodb)
      - Pricing
    ...
    - Monitor and troubleshoot
      ...
      - [View Knowledge Catalog insights](https://firebase.google.com/docs/firestore/enterprise/knowledge-catalog-mongodb)
...
- Storage
  ...
  - [Billing requirements FAQ](https://firebase.google.com/docs/storage/faqs-storage-changes-announced-sept-2024)
...
- Cloud Functions
  ...
  - [Try the experimental Dart SDK](https://firebase.google.com/docs/functions/start-dart)
  ...
  - API Reference
    ...
    - [Experimental Dart SDK](https://pub.dev/packages/firebase_functions)
...
- Firebase ML
  ...
  - [Migrate to Cloud Storage](https://firebase.google.com/docs/ml/migrate-to-cloud-storage)
  - Use a custom model
...
- [AI tools, skills, & MCP](https://firebase.google.com/docs/ai-assistance/agent-skills)
- [Firebase Studio (deprecated)](https://firebase.google.com/docs/studio)
- Build AI-powered apps
...
- On this page
- [Key capabilities](https://firebase.google.com/docs/extensions#key_capabilities)
- [How does it work?](https://firebase.google.com/docs/extensions#how_does_it_work)
- [Implementation path](https://firebase.google.com/docs/extensions#implementation_path)
- [Next steps](https://firebase.google.com/docs/extensions#next_steps)
...
# Firebase Extensions      Stay organized with collections      Save and categorize content based on your preferences.
...
[Explore Extensions Hub](https://extensions.dev/extensions) [Learn how to install an extension](https://firebase.google.com/docs/extensions/install-extensions) [Learn how to build your own extension](https://firebase.google.com/docs/extensions/publishers)
...
|     |     |
| --- | --- |
| **Reduce time spent on development, maintenance, and**<br>**growth** | Since an extension is a packaged solution, all you do is install and<br>configure the extension.<br>With extensions, you don't spend time researching, writing, and<br>debugging the code that implements functionality or automates a task for<br>your app or project.<br>Explore [Extensions Hub](https://extensions.dev/extensions) to find solutions for your app or<br>project. |
| **Built to be configurable and reusable** | Each installed instance of an extension is unique.<br>You specify configuration values for the extension that are unique for<br>your app, project, or use case. Depending on what the extension does,<br>these values could be almost anything: a Cloud Firestore path, image<br>dimensions, or a GitHub URL.<br>You can reuse the same extension in different projects. You can even<br>install multiple instances of the same extension in a single project.<br>Each installed instance can have its own customized configuration. |
| **Integrates the Firebase platform** | Extensions can fill that missing piece of your existing<br>architecture.<br>Extensions can respond to events generated by<br>the Firebase products that you already use in your app. A change in one<br>Firebase product can trigger an extension to perform its task, even a<br>task using another product. For example, a specific Realtime Database write<br>can trigger sending a new Firebase Cloud Messaging notification.<br>An extension can also integrate your Firebase project with other Google<br>Cloud Platform products (like BigQuery and Google Translate) or even<br>third-party services (like Mailchimp and Bit.ly).<br>And triggering events aren't limited to Firebase events; you can even<br>trigger an extension directly with an HTTPS request, or at a scheduled<br>interval. |
| **Security and limited access** | The application logic for extensions runs on the backend, using<br>Google Cloud Functions, so the code is fully isolated from the<br>client.<br>Also, extensions themselves are isolated from the rest of your project<br>because an installed extension is granted<br>[limited access](https://firebase.google.com/docs/extensions/permissions-granted-to-extension)<br>to only the resources and data that are clearly listed before<br>installation. |
| **Zero maintenance** | Install and configure an extension for your Firebase project. After<br>that, the backend automatically scales computing resources up and down<br>to match the needs of your extension.<br>You never worry about credentials, server configuration, provisioning<br>new servers, or decommissioning old ones. |

## How does it work?

At its core, a Firebase Extension is code that performs a task
whenever a **_specifically defined event occurs in your app or project_**.
...
[_extension directory_](https://firebase.google.com/docs/extensions/overview-use-extensions#view-source-code)
...
|  | **Evaluate, install and configure an extension** | When you find an extension that solves a need in your app or project,<br>you can evaluate the extension with the [Extensions emulator](https://firebase.google.com/docs/emulator-suite/use_extensions),<br>then install the extension via the<br>[Firebase console](https://firebase.google.com/docs/extensions/install-extensions?platform=console)<br>or the<br>[Firebase CLI](https://firebase.google.com/docs/extensions/install-extensions?platform=cli).<br>Configure the extension so that it's customized for your app or<br>project. |
|  | **Manage the extension** | View and manage the installed extension using the<br>[Firebase console](https://firebase.google.com/docs/extensions/manage-installed-extensions?platform=console)<br>or the<br>[Firebase CLI](https://firebase.google.com/docs/extensions/manage-installed-extensions?platform=cli). |
...
[![Google Developers](https://www.gstatic.com/devrel-devsite/prod/v8b2f8e7f8a7704cc38c0519ef05e8f889c427cc26f7c8f743e84df2a01b1dee7/firebase/images/lockup-google-for-developers.svg)](https://developers.google.com/)
...
- [Manage cookies](https://firebase.google.com/docs/extensions#)
