...
- [Versions](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/#)
...
- [English](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/#)
  ...
  - [中文 (Chinese)](https://kubernetes.io/zh-cn/docs/concepts/workloads/controllers/cron-jobs/)
  - [Bahasa Indonesia (Indonesian)](https://kubernetes.io/id/docs/concepts/workloads/controllers/cron-jobs/)
  - [日本語 (Japanese)](https://kubernetes.io/ja/docs/concepts/workloads/controllers/cron-jobs/)
  - [한국어 (Korean)](https://kubernetes.io/ko/docs/concepts/workloads/controllers/cron-jobs/)
  - [Português (Portuguese)](https://kubernetes.io/pt-br/docs/concepts/workloads/controllers/cron-jobs/)
  - [Русский (Russian)](https://kubernetes.io/ru/docs/concepts/workloads/controllers/cron-jobs/)
  - [Español (Spanish)](https://kubernetes.io/es/docs/concepts/workloads/controllers/cron-jobs/)
  - বাংলা (Bengali)
...
For example, in certain circumstances, a single CronJob can create multiple concurrent Jobs. See the [limitations](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/#cron-job-limitations) below.
...
## Example [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#example)

This example CronJob manifest prints the current time and a hello message every minute:

[`application/job/cronjob.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/application/job/cronjob.yaml)![](https://kubernetes.io/images/copycode.svg)
...
## Writing a CronJob spec [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#writing-a-cronjob-spec)

### Schedule syntax [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#schedule-syntax)
...
### Job template [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#job-template)

The `.spec.jobTemplate` defines a template for the Jobs that the CronJob creates, and it is required.
It has exactly the same schema as a [Job](https://kubernetes.io/docs/concepts/workloads/controllers/job/), except that
it is nested and does not have an `apiVersion` or `kind`.
You can specify common metadata for the templated Jobs, such as
[labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels) or
[annotations](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations).
...
### Deadline for delayed Job start [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#starting-deadline)
...
### Concurrency policy [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#concurrency-policy)
...
### Schedule suspension [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#schedule-suspension)
...
[starting deadline](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/#starting-deadline), the missed Jobs are scheduled immediately.

### Jobs history limits [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#jobs-history-limits)
...
### Time zones [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#time-zones)

FEATURE STATE:`Kubernetes v1.27 [stable]`

For CronJobs with no time zone specified, the [kube-controller-manager](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-controller-manager/)
...
## CronJob limitations [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#cron-job-limitations)

### Unsupported TimeZone specification [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#unsupported-timezone-specification)
...
using the [time zone field](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/#time-zones), instead.

### Modifying a CronJob [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#modifying-a-cronjob)
...
### Job creation [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#job-creation)
...
## What's next [Heading self-link](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/\#what-s-next)

- Learn about [Pods](https://kubernetes.io/docs/concepts/workloads/pods/) and
[Jobs](https://kubernetes.io/docs/concepts/workloads/controllers/job/), two concepts
...
see [Running automated tasks with CronJobs](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/).
...
[report a problem](https://github.com/kubernetes/website/issues/new?title=Issue%20with%20k8s.io/docs/concepts/workloads/controllers/cron-jobs/)
or
[suggest an improvement](https://github.com/kubernetes/website/issues/new?title=Improvement%20for%20k8s.io/docs/concepts/workloads/controllers/cron-jobs/).
...
- [Русский (Russian)](https://kubernetes.io/ru/docs/concepts/workloads/controllers/cron-jobs/)
- [Español (Spanish)](https://kubernetes.io/es/docs/concepts/workloads/controllers/cron-jobs/)
- [Light](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/)
- [Dark](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/)
- [Auto](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/)