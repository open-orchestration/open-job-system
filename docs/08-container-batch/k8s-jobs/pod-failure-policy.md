...
- [Versions](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#)
...
- [English](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#)
  ...
  - [中文 (Chinese)](https://kubernetes.io/zh-cn/docs/tasks/job/pod-failure-policy/)
  - বাংলা (Bengali)
...
[Edit this page](https://github.com/kubernetes/website/edit/main/content/en/docs/tasks/job/pod-failure-policy.md) [Create child page](https://github.com/kubernetes/website/new/main/content/en/docs/tasks/job/pod-failure-policy.md?filename=change-me.md&value=---%0Atitle%3A+%22Long+Page+Title%22%0AlinkTitle%3A+%22Short+Nav+Title%22%0Aweight%3A+100%0Adescription%3A+%3E-%0A+++++Page+description+for+heading+and+indexes.%0A---%0A%0A%23%23+Heading%0A%0AEdit+this+template+to+create+your+new+page.%0A%0A%2A+Give+it+a+good+name%2C+ending+in+%60.md%60+-+e.g.+%60getting-started.md%60%0A%2A+Edit+the+%22front+matter%22+section+at+the+top+of+the+page+%28weight+controls+how+its+ordered+amongst+other+pages+in+the+same+directory%3B+lowest+number+first%29.%0A%2A+Add+a+good+commit+message+at+the+bottom+of+the+page+%28%3C80+characters%3B+use+the+extended+description+field+for+more+detail%29.%0A%2A+Create+a+new+branch+so+you+can+preview+your+new+file+and+request+a+review+via+Pull+Request.%0A) [Create an issue](https://github.com/kubernetes/website/issues/new?title=Handling%20retriable%20and%20non-retriable%20pod%20failures%20with%20Pod%20failure%20policy) [Print entire section](https://kubernetes.io/docs/tasks/job/_print/)

- [Before you begin](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#before-you-begin)
- [Usage scenarios](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#usage-scenarios)
  - [Using Pod failure policy to avoid unnecessary Pod retries](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#pod-failure-policy-failjob)
  - [Using Pod failure policy to ignore Pod disruptions](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#pod-failure-policy-ignore)
  - [Using Pod failure policy to avoid unnecessary Pod retries based on custom Pod Conditions](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#pod-failure-policy-config-issue)
  - [Using Pod Failure Policy to avoid unnecessary Pod retries per index](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#backoff-limit-per-index-failindex)
- [Alternatives](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#alternatives)

1. [Kubernetes Documentation](https://kubernetes.io/docs/)
2. [Tasks](https://kubernetes.io/docs/tasks/)
3. [Run Jobs](https://kubernetes.io/docs/tasks/job/)
4. Handling retriable and non-retriable pod failures with Pod failure policy
...
within a [Job](https://kubernetes.io/docs/concepts/workloads/controllers/job/).
...
- avoid Job failures due to Pod disruptions (such [preemption](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/#preemption),
[API-initiated eviction](https://kubernetes.io/docs/concepts/scheduling-eviction/api-eviction/)
or [taint](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/)-based eviction).

## Before you begin [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#before-you-begin)

You should already be familiar with the basic use of [Job](https://kubernetes.io/docs/concepts/workloads/controllers/job/).
...
## Usage scenarios [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#usage-scenarios)

Consider the following usage scenarios for Jobs that define a Pod failure policy :

- [Avoiding unnecessary Pod retries](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#pod-failure-policy-failjob)
- [Ignoring Pod disruptions](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#pod-failure-policy-ignore)
- [Avoiding unnecessary Pod retries based on custom Pod Conditions](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#pod-failure-policy-config-issue)
- [Avoiding unnecessary Pod retries per index](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#backoff-limit-per-index-failindex)

### Using Pod failure policy to avoid unnecessary Pod retries [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#pod-failure-policy-failjob)
...
[`/controllers/job-pod-failure-policy-failjob.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples//controllers/job-pod-failure-policy-failjob.yaml)![](https://kubernetes.io/images/copycode.svg)
...
In the Job status, the following conditions display:
   ...
   - `FailureTarget` condition: has a `reason` field set to `PodFailurePolicy` and
     ...
     For details, see [Termination of Job Pods](https://kubernetes.io/docs/concepts/workloads/controllers/job/#termination-of-job-pods).
...
#### Clean up [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#clean-up)
...
### Using Pod failure policy to ignore Pod disruptions [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#pod-failure-policy-ignore)
...
[`/controllers/job-pod-failure-policy-ignore.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples//controllers/job-pod-failure-policy-ignore.yaml)![](https://kubernetes.io/images/copycode.svg)
...
#### Cleaning up [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#cleaning-up)
...
### Using Pod failure policy to avoid unnecessary Pod retries based on custom Pod Conditions [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#pod-failure-policy-config-issue)
...
(see: [Pod Phase](https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#pod-phase)).

1. Examine the following manifest:



[`/controllers/job-pod-failure-policy-config-issue.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples//controllers/job-pod-failure-policy-config-issue.yaml)![](https://kubernetes.io/images/copycode.svg)
...
#### Cleaning up [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#cleaning-up-1)
...
### Using Pod Failure Policy to avoid unnecessary Pod retries per index [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#backoff-limit-per-index-failindex)
...
[`/controllers/job-backoff-limit-per-index-failindex.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples//controllers/job-backoff-limit-per-index-failindex.yaml)![](https://kubernetes.io/images/copycode.svg)
...
#### Cleaning up [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#cleaning-up-2)
...
## Alternatives [Heading self-link](https://kubernetes.io/docs/tasks/job/pod-failure-policy/\#alternatives)
...
[report a problem](https://github.com/kubernetes/website/issues/new?title=Issue%20with%20k8s.io/docs/tasks/job/pod-failure-policy/)
or
[suggest an improvement](https://github.com/kubernetes/website/issues/new?title=Improvement%20for%20k8s.io/docs/tasks/job/pod-failure-policy/).

Last modified February 12, 2026 at 4:20 PM PST: [Fix incorrect time estimate in Pod failure policy example (8bf021e511)](https://github.com/kubernetes/website/commit/8bf021e511ed9ac791c696c33b32261e96e7ca6a)
...
- [English](https://kubernetes.io/docs/tasks/job/pod-failure-policy/#)
- [中文 (Chinese)](https://kubernetes.io/zh-cn/docs/tasks/job/pod-failure-policy/)
- [Light](https://kubernetes.io/docs/tasks/job/pod-failure-policy/)
- [Dark](https://kubernetes.io/docs/tasks/job/pod-failure-policy/)
- [Auto](https://kubernetes.io/docs/tasks/job/pod-failure-policy/)