[![](https://docs.nats.io/~gitbook/image?url=https%3A%2F%2F1487470910-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-legacy-files%2Fo%2Fspaces%252F-LqMYcZML1bsXrN3Ezg0%252Favatar.png%3Fgeneration%3D1571848018902627%26alt%3Dmedia&width=32&dpr=3&quality=100&sign=b857e0c2&sv=2)![](https://docs.nats.io/~gitbook/image?url=https%3A%2F%2F1487470910-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-legacy-files%2Fo%2Fspaces%252F-LqMYcZML1bsXrN3Ezg0%252Favatar.png%3Fgeneration%3D1571848018902627%26alt%3Dmedia&width=32&dpr=3&quality=100&sign=b857e0c2&sv=2)\\
NATS Docs](https://docs.nats.io/)

`⌘Ctrl`  `k`

[NATS.io](https://nats.io/) [NATS by Example](https://natsbyexample.com/) [GitHub](https://github.com/nats-io) [Slack](https://slack.nats.io/) [Twitter](https://twitter.com/nats_io)
...
- Release Notes
  ...
  - [What's New!](https://docs.nats.io/release-notes/whats_new)
...
- NATS Concepts
  ...
  - [Subject Mapping and Partitioning](https://docs.nats.io/nats-concepts/subject_mapping)
  - [NATS Service Infrastructure](https://docs.nats.io/nats-concepts/service_infrastructure)
  - [Security](https://docs.nats.io/nats-concepts/security)
  - [Connectivity](https://docs.nats.io/nats-concepts/connectivity)
...
- Running a NATS service
  ...
  - [Installing, running and deploying a NATS Server](https://docs.nats.io/running-a-nats-service/introduction)
  - [Environmental considerations](https://docs.nats.io/running-a-nats-service/environment)
  ...
  - [Managing and Monitoring your NATS Server Infrastructure](https://docs.nats.io/running-a-nats-service/nats_admin)
...
- Reference
  ...
  - [NATS Protocols](https://docs.nats.io/reference/reference-protocols)
  - [Roadmap](https://docs.nats.io/reference/roadmap)
  - [Contributing](https://docs.nats.io/reference/contributing)
...
[Powered by GitBook](https://www.gitbook.com/?utm_source=content&utm_medium=trademark&utm_campaign=-LqMYcZML1bsXrN3Ezg0&utm_content=site_lAQT0) [Powered by GitBook](https://www.gitbook.com/?utm_source=content&utm_medium=trademark&utm_campaign=-LqMYcZML1bsXrN3Ezg0&utm_content=site_lAQT0)

On this page

- [Stream limits and message retention](https://docs.nats.io/nats-concepts/jetstream/streams#stream-limits-and-message-retention)
- [Configuration](https://docs.nats.io/nats-concepts/jetstream/streams#configuration)
- [StorageType](https://docs.nats.io/nats-concepts/jetstream/streams#storagetype)
- [Subjects](https://docs.nats.io/nats-concepts/jetstream/streams#subjects)
...
- [Sources and Mirrors](https://docs.nats.io/nats-concepts/jetstream/streams#sources-and-mirrors)
- [AllowRollup](https://docs.nats.io/nats-concepts/jetstream/streams#allowrollup)
- [RePublish](https://docs.nats.io/nats-concepts/jetstream/streams#republish)
- [SubjectTransform](https://docs.nats.io/nats-concepts/jetstream/streams#subjecttransform)

Was this helpful?

For the complete documentation index, see [llms.txt](https://docs.nats.io/llms.txt). This page is also available as [Markdown](https://docs.nats.io/nats-concepts/jetstream/streams.md).

Copy

On this page

1. [NATS Concepts](https://docs.nats.io/nats-concepts)
2. [JetStream](https://docs.nats.io/nats-concepts/jetstream)
...
## [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#stream-limits-and-message-retention)    Stream limits and message retention

Streams support various retention policies which define when messages in the stream can be automatically deleted, such as when stream limits are hit (like max count, size or age of messages), or also more novel options that apply on top of the limits such as interest-based retention or work-queue semantics (see [Retention Policy](https://docs.nats.io/nats-concepts/jetstream/streams#retentionpolicy)).

Upon reaching message limits, the server will automatically discard messages either by removing the oldest messages to make room for new ones (`DiscardOld`) or by refusing to store new messages (`DiscardNew`). For more details, see [Discard Policy](https://docs.nats.io/nats-concepts/jetstream/streams#discardpolicy).
...
## [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#configuration)    Configuration
...
[Storage](https://docs.nats.io/nats-concepts/jetstream/streams#storagetype)
...
A list of subjects to bind. Wildcards are supported. Cannot be set for [mirror](https://docs.nats.io/nats-concepts/jetstream/streams#mirrors) streams.
...
[Retention](https://docs.nats.io/nats-concepts/jetstream/streams#retentionpolicy)
...
[Discard](https://docs.nats.io/nats-concepts/jetstream/streams#discardpolicy)
...
[Mirror](https://docs.nats.io/nats-concepts/jetstream/streams#mirrors)
...
[Sources](https://docs.nats.io/nats-concepts/jetstream/streams#stream-sources)
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#storagetype)    StorageType
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#subjects)    Subjects

_Note: a stream configured as a_ [_mirror_](https://docs.nats.io/nats-concepts/jetstream/streams#mirrors) _cannot be configured with a set of subjects. A mirror implicitly sources a subset of the origin stream (optionally with a filter), but does not subscribe to additional subjects._
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#retentionpolicy)    RetentionPolicy
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#discardpolicy)    DiscardPolicy
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#placement)    Placement
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#sources-and-mirrors)    Sources and Mirrors
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#stream-sources)    Stream sources
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#mirrors)    Mirrors
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#allowrollup)    AllowRollup
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#republish)    RePublish
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream/streams\#subjecttransform)    SubjectTransform
...
[PreviousJetStream](https://docs.nats.io/nats-concepts/jetstream) [NextSource and Mirror Streams](https://docs.nats.io/nats-concepts/jetstream/source_and_mirror)

Last updated 1 month ago

Was this helpful?

This site uses cookies to deliver its service and to analyze traffic. By browsing this site, you accept the [privacy policy](https://nats.io/privacy).
