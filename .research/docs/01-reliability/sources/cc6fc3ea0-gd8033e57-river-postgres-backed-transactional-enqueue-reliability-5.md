[brandur.org](https://brandur.org/)
  * [Articles](https://brandur.org/articles)
  * [Atoms](https://brandur.org/atoms)
  * [Fragments](https://brandur.org/fragments)
  * [Newsletter](https://brandur.org/newsletter)
  * [Sequences](https://brandur.org/sequences)
  * [Now](https://brandur.org/now)
  * [Uses](https://brandur.org/uses)
  * [About](https://brandur.org/about)


Auto
#  River: a Fast, Robust Job Queue for Go + Postgres 
![](https://brandur.org/assets/images/river/shrine.jpg)
Article
...
Location
San Francisco
See comments and reaction **[on Hacker News](https://news.ycombinator.com/item?id=38349716)**. 
I'm on X/Twitter at [@brandur](https://twitter.com/brandur).
Nov 20, 2023
  1. [River is born](https://brandur.org/river#river-is-born)
    1. [Designed for generics](https://brandur.org/river#generics)
    2. [With performance in mind](https://brandur.org/river#performance)
  2. [What's different now?](https://brandur.org/river#whats-different)
    1. [Single dependency stacks](https://brandur.org/river#single-dependency-stacks)
    2. [Ruby non-parallelism](https://brandur.org/river#ruby-non-parallelism)
    3. [Improvements in Postgres](https://brandur.org/river#postgres-improvements)
  3. [Try it](https://brandur.org/river#try-it)


Years ago I wrote about [my trouble with a job queue in Postgres](https://brandur.org/postgres-queues), in which table bloat caused by long-running queries slowed down the workers’ capacity to lock jobs as they hunted across millions of dead tuples trying to find a live one.
...
![Job failure because data is not yet visible](https://brandur.org/assets/images/river/data-not-visible.svg)
* * *
...
![Job failure because data rolled back](https://brandur.org/assets/images/river/data-roll-back.svg)
* * *
...
![Job post-transaction emit failure](https://brandur.org/assets/images/river/job-emit-failure.svg)
* * *
...
![Job failure because data is not complete](https://brandur.org/assets/images/river/data-not-complete.svg)
* * *
...
## [River is born](https://brandur.org/river#river-is-born)
...
[![Screen shot of River home page](https://brandur.org/assets/images/river/river-home.png)](https://riverqueue.com)
### [Designed for generics](https://brandur.org/river#generics)
...
### [With performance in mind](https://brandur.org/river#performance)
...
## [What's different now?](https://brandur.org/river#whats-different)
...
### [Single dependency stacks](https://brandur.org/river#single-dependency-stacks)
Another reason is that dependency minimization is great. I’ve written previously about how at work [we run a single dependency stack](https://brandur.org/fragments/single-dependency-stacks). No ElastiCache, no Redis, no bespoke queueing components, just Postgres. If there’s a problem with Postgres, we can fix it. No need to develop expertise in how to operate rarely used, black box systems.
...
### [Improvements in Postgres](https://brandur.org/river#postgres-improvements)
...
## [Try it](https://brandur.org/river#try-it)
...
Did I make a mistake? Please consider [sending a pull request](https://github.com/brandur/sorg/edit/master/content/articles/river.md). 
