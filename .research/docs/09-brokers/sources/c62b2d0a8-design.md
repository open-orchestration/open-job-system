...
- [Releases](https://kafka.apache.org/43/getting-started/upgrade/#)
...
[View page source](https://github.com/apache/kafka-site//tree/markdown/content/en/43/getting-started/upgrade.md) [Edit this page](https://github.com/apache/kafka-site//edit/markdown/content/en/43/getting-started/upgrade.md) [Create child page](https://github.com/apache/kafka-site//new/markdown/content/en/43/getting-started?filename=change-me.md&value=---%0Atitle%3A+%22Long+Page+Title%22%0AlinkTitle%3A+%22Short+Nav+Title%22%0Aweight%3A+100%0Adescription%3A+%3E-%0A+++++Page+description+for+heading+and+indexes.%0A---%0A%0A%23%23+Heading%0A%0AEdit+this+template+to+create+your+new+page.%0A%0A%2A+Give+it+a+good+name%2C+ending+in+%60.md%60+-+e.g.+%60getting-started.md%60%0A%2A+Edit+the+%22front+matter%22+section+at+the+top+of+the+page+%28weight+controls+how+its+ordered+amongst+other+pages+in+the+same+directory%3B+lowest+number+first%29.%0A%2A+Add+a+good+commit+message+at+the+bottom+of+the+page+%28%3C80+characters%3B+use+the+extended+description+field+for+more+detail%29.%0A%2A+Create+a+new+branch+so+you+can+preview+your+new+file+and+request+a+review+via+Pull+Request.%0A) [Create documentation issue](https://github.com/apache/kafka-site//issues/new?title=Upgrading) [Print entire section](https://kafka.apache.org/43/getting-started/_print/)

- [Upgrading to 4.3.0](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-to-430)
  - [Upgrading Servers to 4.3.0 from any version 3.3.x through 4.2.0](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-servers-to-430-from-any-version-33x-through-420)
  - [Notable changes in 4.3.0](https://kafka.apache.org/43/getting-started/upgrade/#notable-changes-in-430)
- [Upgrading to 4.2.1](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-to-421)
  - [Notable changes in 4.2.1](https://kafka.apache.org/43/getting-started/upgrade/#notable-changes-in-421)
- [Upgrading to 4.2.0](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-to-420)
  - [Upgrading Servers to 4.2.0 from any version 3.3.x through 4.1.x](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-servers-to-420-from-any-version-33x-through-41x)
  - [Notable changes in 4.2.0](https://kafka.apache.org/43/getting-started/upgrade/#notable-changes-in-420)
- [Upgrading to 4.1.2](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-to-412)
  - [Notable changes in 4.1.2](https://kafka.apache.org/43/getting-started/upgrade/#notable-changes-in-412)
- [Upgrading to 4.1.1](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-to-411)
  - [Notable changes in 4.1.1](https://kafka.apache.org/43/getting-started/upgrade/#notable-changes-in-411)
- [Upgrading to 4.1.0](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-to-410)
  - [Upgrading Servers to 4.1.0 from any version 3.3.x through 4.0.x](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-servers-to-410-from-any-version-33x-through-40x)
  - [Notable changes in 4.1.0](https://kafka.apache.org/43/getting-started/upgrade/#notable-changes-in-410)
- [Upgrading to 4.0.1](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-to-401)
  - [Upgrading Clients to 4.0.1](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-clients-to-401)
  - [Upgrading Servers to 4.0.1 from any version 3.3.x through 3.9.x](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-servers-to-401-from-any-version-33x-through-39x)
  - [Notable changes in 4.0.1](https://kafka.apache.org/43/getting-started/upgrade/#notable-changes-in-401)
  - [Notable changes in 4.0.0](https://kafka.apache.org/43/getting-started/upgrade/#notable-changes-in-400)
- [Upgrading to 3.9.0 and older versions](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-to-390-and-older-versions)
...
2. [Getting Started](https://kafka.apache.org/43/getting-started/)
3. Upgrading
...
### Notable changes in 4.3.0 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#notable-changes-in-430)
...
- The new config have been introduced: `remote.log.metadata.topic.min.isr` with 2 as default value. You can correct the min.insync.replicas for the existed \_\_remote\_log\_metadata topic via kafka-configs.sh if needed. For further details, please refer to [KIP-1235](https://cwiki.apache.org/confluence/x/yommFw).
...
- The `kafka-streams-scala` library is deprecated as of Kafka 4.3 and will be removed in Kafka 5.0. For further details, please refer to the [migration guide](https://kafka.apache.org/43/streams/developer-guide/scala-migration).
...
## Upgrading to 4.2.1 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-to-421)

### Notable changes in 4.2.1 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#notable-changes-in-421)
...
### Notable changes in 4.2.0 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#notable-changes-in-420)
...
- The Streams Rebalance Protocol ( [KIP-1071](https://cwiki.apache.org/confluence/display/KAFKA/KIP-1071%3A+Streams+Rebalance+Protocol)) is now production-ready for its core feature set. This broker-driven rebalancing system designed specifically for Kafka Streams applications provides faster, more stable rebalances and better observability. For more information about the supported feature set, usage, and migration, please refer to the [Streams developer guide](https://kafka.apache.org/43/streams/developer-guide/streams-rebalance-protocol). Due to a critical broker-side bug in the offline migration code ( [KAFKA-20254](https://issues.apache.org/jira/browse/KAFKA-20254)), we recommend against doing migrations from classic to streams groups in 4.2.0. Newly created streams groups are not impacted. The fix will be targeted for a future release.
...
- A new implementation of `ConnectorClientConfigOverridePolicy`, `AllowlistConnectorClientConfigOverridePolicy`, has been added. This enables specifying the configurations that connectors can override via `connector.client.config.override.allowlist`. From Kafka 5.0.0, this will be the default [connector.client.config.override.policy](https://kafka.apache.org/43/getting-started/upgrade/documentation/#connectconfigs_connector.client.config.override.policy) policy. The `PrincipalConnectorClientConfigOverridePolicy` policy is now deprecated and will be removed in Kafka 5.0.0. For further details, please refer to [KIP-1188](https://cwiki.apache.org/confluence/x/2IkvFg).
...
## Upgrading to 4.1.2 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-to-412)

### Notable changes in 4.1.2 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#notable-changes-in-412)
...
## Upgrading to 4.1.1 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-to-411)

### Notable changes in 4.1.1 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#notable-changes-in-411)
...
## Upgrading to 4.1.0 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-to-410)
...
### Upgrading Servers to 4.1.0 from any version 3.3.x through 4.0.x [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-servers-to-410-from-any-version-33x-through-40x)

The rolling upgrade procedure for 4.1.x is identical to the 4.0 upgrade. Please refer to the [Upgrading Servers to 4.0.x](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-servers-to-401-from-any-version-33x-through-39x) section for detailed step-by-step instructions.

### Notable changes in 4.1.0 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#notable-changes-in-410)
...
## Upgrading to 4.0.1 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-to-401)

### Upgrading Clients to 4.0.1 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-clients-to-401)

**For a rolling upgrade:**

1. Upgrade the clients one at a time: shut down the client, update the code, and restart it.
2. Clients (including Streams and Connect) must be on version 2.1 or higher before upgrading to 4.0. Many deprecated APIs were removed in Kafka 4.0. For more information about the compatibility, please refer to the [compatibility matrix](https://kafka.apache.org/43/getting-started/compatibility) or [KIP-1124](https://cwiki.apache.org/confluence/x/y4kgF).

### Upgrading Servers to 4.0.1 from any version 3.3.x through 3.9.x [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-servers-to-401-from-any-version-33x-through-39x)

Note: Apache Kafka 4.0 only supports KRaft mode - ZooKeeper mode has been removed. As such, **broker upgrades to 4.0.0 (and higher) require KRaft mode and the software and metadata versions must be at least 3.3.x** (the first version when KRaft mode was deemed production ready). For clusters in KRaft mode with versions older than 3.3.x, we recommend upgrading to 3.9.x before upgrading to 4.0.x. Clusters in ZooKeeper mode have to be [migrated to KRaft mode](https://kafka.apache.org/43/operations/kraft/#zookeeper-to-kraft-migration) before they can be upgraded to 4.0.x.
...
### Notable changes in 4.0.1 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#notable-changes-in-401)
...
- Kafka Streams include a critical fix to upgrade from `KStreams#transformValues()` (remove with 4.0.0 release) to `KStreams#processValues()`. For more details, see the [migration guide](https://kafka.apache.org/43/streams/developer-guide/dsl-api/#transformers-removal-and-migration-to-processors).

### Notable changes in 4.0.0 [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#notable-changes-in-400)
...
- Apache Kafka 4.0 only supports KRaft mode - ZooKeeper mode has been removed. About version upgrade, check [Upgrading to 4.0.1 from any version 3.3.x through 3.9.x](https://kafka.apache.org/43/getting-started/upgrade/#upgrading-servers-to-401-from-any-version-33x-through-39x) for more info.
...
- A number of deprecated classes, methods, configurations and tools have been removed.
  ...
  - **MirrorMaker**
    - The original MirrorMaker (MM1) and related classes were removed. Please use the Connect-based MirrorMaker (MM2), as described in the [Geo-Replication section.](https://kafka.apache.org/43/documentation/#georeplication).
  ...
  - **Tools**
    - The `kafka.common.MessageReader` class was removed. Please use the [`org.apache.kafka.tools.api.RecordReader`](https://kafka.apache.org/43/javadoc/org/apache/kafka/tools/api/RecordReader.html) interface to build custom readers for the `kafka-console-producer` tool.
    ...
    - The `kafka.serializer.Decoder` trait was removed, please use the [`org.apache.kafka.tools.api.Decoder`](https://kafka.apache.org/43/javadoc/org/apache/kafka/tools/api/Decoder.html) interface to build custom decoders for the `kafka-dump-log` tool.
  ...
  - **Kafka Streams**
    ...
    - The most important changes are highlighted in the [Kafka Streams upgrade guide](https://kafka.apache.org/43/streams/upgrade-guide/#streams-api-changes-in-400).
    - For a full list of changes, see [KAFKA-12822](https://issues.apache.org/jira/browse/KAFKA-12822).
    - If you are using `KStream#transformValues()` which was removed with Apache Kafka 4.0.0 release, and you need to rewrite your program to use `KStreams#processValues()` instead, pay close attention to the [migration guide](https://kafka.apache.org/43/streams/developer-guide/dsl-api/#transformers-removal-and-migration-to-processors).
- Other changes:
  ...
  - For implementors of RemoteLogMetadataManager (RLMM), a new API `nextSegmentWithTxnIndex` is introduced in RLMM to allow the implementation to return the next segment metadata with a transaction index. This API is used when the consumers are enabled with isolation level as READ\_COMMITTED. See [KIP-1058](https://cwiki.apache.org/confluence/x/BwuTEg) for more details.
...
## Upgrading to 3.9.0 and older versions [Heading self-link](https://kafka.apache.org/43/getting-started/upgrade/\#upgrading-to-390-and-older-versions)

See [Upgrading From Previous Versions](https://kafka.apache.org/39/documentation/#upgrade) in the 3.9 documentation.
...
[‹ Previous:Ecosystem](https://kafka.apache.org/43/getting-started/ecosystem/)

[Next:KRaft vs ZooKeeper\\
