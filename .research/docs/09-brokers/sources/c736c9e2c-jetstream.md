...
- [JetStream capabilities](https://docs.nats.io/nats-concepts/jetstream#jetstream-capabilities)
- [Key Value Store](https://docs.nats.io/nats-concepts/jetstream#key-value-store)
- [Object Store](https://docs.nats.io/nats-concepts/jetstream#object-store)
- [Legacy](https://docs.nats.io/nats-concepts/jetstream#legacy)

Was this helpful?

For the complete documentation index, see [llms.txt](https://docs.nats.io/llms.txt). This page is also available as [Markdown](https://docs.nats.io/nats-concepts/jetstream.md).
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#additional-capabilities-enabled-by-jetstream)    Additional capabilities enabled by JetStream
...
- [Key Value Store](https://docs.nats.io/nats-concepts/jetstream#key-value-store) A map (associative array) with atomic operations

- [Object Store](https://docs.nats.io/nats-concepts/jetstream#object-store) File transfer, replications and storage API. Uses chunked transfers for scalability.
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#configuration)    Configuration
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#examples)    Examples

For runnable JetStream code examples, refer to [NATS by Example](https://natsbyexample.com/).

#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#goals)    Goals
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#jetstream-capabilities)    JetStream capabilities

#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#streaming-temporal-decoupling-between-the-publishers-and-subscribers)    Streaming: temporal decoupling between the publishers and subscribers
...
JetStream provides _both_ the ability to _consume_ messages as they are published (i.e. 'queueing') as well as the ability to _replay_ messages on demand (i.e. 'streaming'). See [retention policies](https://docs.nats.io/nats-concepts/jetstream#Retention-policies-and-limits) below.
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#persistent-and-consistent-distributed-storage)    Persistent and Consistent distributed storage
...
In JetStream the configuration for storing messages is defined separately from how they are consumed. Storage is defined in a [_Stream_](https://docs.nats.io/nats-concepts/jetstream/streams) and consuming messages is defined by multiple [_Consumers_](https://docs.nats.io/nats-concepts/jetstream/consumers).
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#de-coupled-flow-control)    De-coupled flow control
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#exactly-once-semantics)    Exactly once semantics
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#consumers)    Consumers
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#key-value-store)    Key Value Store
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#watch-and-history)    Watch and History
...
#### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#atomic-updates-and-locking)    Atomic updates and locking
...
### [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#object-store)    Object Store
...
## [Direct link to heading](https://docs.nats.io/nats-concepts/jetstream\#legacy)    Legacy
...
[PreviousQueueing Walkthrough](https://docs.nats.io/nats-concepts/core-nats/queue/queues_walkthrough) [NextStreams](https://docs.nats.io/nats-concepts/jetstream/streams)
