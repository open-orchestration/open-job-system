...
- [Versions](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/#)
...
- [English](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/#)

  - [中文 (Chinese)](https://kubernetes.io/zh-cn/docs/tasks/job/automated-tasks-with-cron-jobs/)
  - [Bahasa Indonesia (Indonesian)](https://kubernetes.io/id/docs/tasks/job/automated-tasks-with-cron-jobs/)
  - [日本語 (Japanese)](https://kubernetes.io/ja/docs/tasks/job/automated-tasks-with-cron-jobs/)
  - [한국어 (Korean)](https://kubernetes.io/ko/docs/tasks/job/automated-tasks-with-cron-jobs/)
  - [Português (Portuguese)](https://kubernetes.io/pt-br/docs/tasks/job/automated-tasks-with-cron-jobs/)
  - বাংলা (Bengali)
...
[Edit this page](https://github.com/kubernetes/website/edit/main/content/en/docs/tasks/job/automated-tasks-with-cron-jobs.md) [Create child page](https://github.com/kubernetes/website/new/main/content/en/docs/tasks/job/automated-tasks-with-cron-jobs.md?filename=change-me.md&value=---%0Atitle%3A+%22Long+Page+Title%22%0AlinkTitle%3A+%22Short+Nav+Title%22%0Aweight%3A+100%0Adescription%3A+%3E-%0A+++++Page+description+for+heading+and+indexes.%0A---%0A%0A%23%23+Heading%0A%0AEdit+this+template+to+create+your+new+page.%0A%0A%2A+Give+it+a+good+name%2C+ending+in+%60.md%60+-+e.g.+%60getting-started.md%60%0A%2A+Edit+the+%22front+matter%22+section+at+the+top+of+the+page+%28weight+controls+how+its+ordered+amongst+other+pages+in+the+same+directory%3B+lowest+number+first%29.%0A%2A+Add+a+good+commit+message+at+the+bottom+of+the+page+%28%3C80+characters%3B+use+the+extended+description+field+for+more+detail%29.%0A%2A+Create+a+new+branch+so+you+can+preview+your+new+file+and+request+a+review+via+Pull+Request.%0A) [Create an issue](https://github.com/kubernetes/website/issues/new?title=Running%20Automated%20Tasks%20with%20a%20CronJob) [Print entire section](https://kubernetes.io/docs/tasks/job/_print/)

- [Before you begin](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/#before-you-begin)
- [Creating a CronJob](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/#creating-a-cron-job)
- [Deleting a CronJob](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/#deleting-a-cron-job)

1. [Kubernetes Documentation](https://kubernetes.io/docs/)
2. [Tasks](https://kubernetes.io/docs/tasks/)
3. [Run Jobs](https://kubernetes.io/docs/tasks/job/)
4. Running Automated Tasks with a CronJob

# Running Automated Tasks with a CronJob

This page shows how to run automated tasks using Kubernetes [CronJob](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/) object.

## Before you begin [Heading self-link](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/\#before-you-begin)
...
## Creating a CronJob [Heading self-link](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/\#creating-a-cron-job)
...
[Watch](https://kubernetes.io/docs/reference/using-api/api-concepts/#api-verbs) for the job to be created in around one minute:
...
## Deleting a CronJob [Heading self-link](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/\#deleting-a-cron-job)
...
You can read more about removing jobs in [garbage collection](https://kubernetes.io/docs/concepts/architecture/garbage-collection/).
...
[report a problem](https://github.com/kubernetes/website/issues/new?title=Issue%20with%20k8s.io/docs/tasks/job/automated-tasks-with-cron-jobs/)
or
[suggest an improvement](https://github.com/kubernetes/website/issues/new?title=Improvement%20for%20k8s.io/docs/tasks/job/automated-tasks-with-cron-jobs/).

Last modified July 04, 2024 at 7:39 PM PST: [Adding glossary tooltip for watch in k/docs (5053a95f53)](https://github.com/kubernetes/website/commit/5053a95f53085b5fe9bcd6d7fe28896f4473d597)
...
- [한국어 (Korean)](https://kubernetes.io/ko/docs/tasks/job/automated-tasks-with-cron-jobs/)
- [Português (Portuguese)](https://kubernetes.io/pt-br/docs/tasks/job/automated-tasks-with-cron-jobs/)
- [Light](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/)
- [Dark](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/)
- [Auto](https://kubernetes.io/docs/tasks/job/automated-tasks-with-cron-jobs/)