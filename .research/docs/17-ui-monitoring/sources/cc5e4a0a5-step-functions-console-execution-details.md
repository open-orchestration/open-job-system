...
[Skip to main content](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#skip-link)

[English](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html# "Language Selector. Currently set to: English")

[Preferences](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#)

[Contact Us](https://aws.amazon.com/contact-us/?cmpid=docs_headercta_contactus)

[Feedback](https://docs.aws.amazon.com/feedback/doc-feedback.html?hidden_service_name=Step+Functions&topic_url=https%3A%2F%2Fdocs.aws.amazon.com%2Fstep-functions%2Flatest%2Fdg%2Fwelcome.html)

[![AWS Documentation](https://docs.aws.amazon.com/assets/r/images/aws_logo_light.svg)](https://docs.aws.amazon.com/)

[Get started](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#)

[Service guides](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#)

[Developer tools](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#)

[AI resources](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#)
...
- [Agent setup guide](https://docs.aws.amazon.com/step-functions/latest/dg/sfn-agent-setup-guide.html)
...
- [Starter templates](https://docs.aws.amazon.com/step-functions/latest/dg/starter-templates.html)
  ...
  - [Triage tickets with Bedrock AgentCore invokeHarness](https://docs.aws.amazon.com/step-functions/latest/dg/sample-bedrock-agentcore-invoke-harness.html)
...
- [Integrating optimized services](https://docs.aws.amazon.com/step-functions/latest/dg/integrate-optimized.html)
  ...
  - [Amazon Bedrock AgentCore](https://docs.aws.amazon.com/step-functions/latest/dg/connect-bedrockagentcore.html)
...
[PDF](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#welcome)

[RSS](https://docs.aws.amazon.com/step-functions/latest/dg/recent-updates.rss)

[Markdown](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.md "Download Markdown")

Focus mode

What is Step Functions? - AWS Step Functions

[Open PDF](https://docs.aws.amazon.com/pdfs/step-functions/latest/dg/step-functions-dg.pdf#welcome "Open PDF")
...
[Standard and Express workflows types](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#welcome-workflows) [Integrating with other services](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#welcome-service-integrations) [Example use cases for workflows](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#application)

###### Managing state and transforming data

Learn about [Passing data between states with variables](https://docs.aws.amazon.com/step-functions/latest/dg/workflow-variables.html) and [Transforming data with JSONata](https://docs.aws.amazon.com/step-functions/latest/dg/transforming-data.html).

With AWS Step Functions, you can create workflows, also called [State machines](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-statemachines.html), to build distributed applications, automate processes, orchestrate
microservices, and create data and machine learning pipelines.

Step Functions is based on _state machines_ and _tasks_. In Step Functions, state machines are called _workflows_, which are a series of event-driven steps. Each step in a workflow is called a _state_. For example, a [Task state](https://docs.aws.amazon.com/step-functions/latest/dg/state-task.html) represents a unit of work that another AWS service performs, such as calling another AWS service or API. Instances of running workflows performing tasks are called _executions_ in Step Functions.

The work in your state machine tasks can also be done using [Activities](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-activities.html) which are workers that exist outside of Step Functions.
...
Start with the [Getting started tutorial](https://docs.aws.amazon.com/step-functions/latest/dg/getting-started.html) in this guide. For advanced topics and use cases, see the modules in [The Step Functions Workshop](https://catalog.workshops.aws/stepfunctions).
...
| Support integrations with all services.<br>Support<br>optimized integrations with some services. | Support integrations with all services. |
| Support _Request Response_<br> pattern for all services<br> <br>Support _Run a Job_ and/or _Wait for_<br>_Callback_ patterns in specific services (see following<br>section for details) | Support _Request Response_ pattern for all services |
...
- [Optimized integrations](https://docs.aws.amazon.com/step-functions/latest/dg/integrate-optimized.html) provide custom options
...
- [Request Response (default)](https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html#connect-default)

Call a service, and let Step Functions progress to the next state after it gets an HTTP
response.

- [Run a job (.sync)](https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html#connect-sync)

Call a service, and have Step Functions wait for a job to complete.

- [Wait for a callback with a task token\\
(.waitForTaskToken)](https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html#connect-wait-token)
...
- **Standard Workflows** support _Request Response_ integrations. Certain services support _Run a Job_
_(.sync)_, or _Wait for Callback_
_(.waitForTaskToken)_ , and both in some cases. See the following optimized integrations table for details.
...
To help decide between the two types, see [Choosing workflow type in Step Functions](https://docs.aws.amazon.com/step-functions/latest/dg/choosing-workflow-type.html).
...
| --- | --- | --- | --- |
| [Over two hundred services](https://docs.aws.amazon.com/step-functions/latest/dg/supported-services-awssdk.html#supported-services-awssdk-list) | Standard & Express | _Not supported_ | Standard |

**Optimized integrations in Step Functions**

| Integrated service | Request Response | Run a Job - _.sync_ | Wait for Callback - _.waitForTaskToken_ |
| --- | --- | --- | --- |
| [Amazon API Gateway](https://docs.aws.amazon.com/step-functions/latest/dg/connect-api-gateway.html) | Standard & Express | _Not supported_ | Standard |
| [Amazon Athena](https://docs.aws.amazon.com/step-functions/latest/dg/connect-athena.html) | Standard & Express | Standard | _Not supported_ |
| [AWS Batch](https://docs.aws.amazon.com/step-functions/latest/dg/connect-batch.html) | Standard & Express | Standard | _Not supported_ |
| [Amazon Bedrock](https://docs.aws.amazon.com/step-functions/latest/dg/connect-bedrock.html) | Standard & Express | Standard | Standard |
| [Amazon Bedrock AgentCore](https://docs.aws.amazon.com/step-functions/latest/dg/connect-bedrockagentcore.html) | Standard & Express | _Not supported_ | _Not supported_ |
| [AWS CodeBuild](https://docs.aws.amazon.com/step-functions/latest/dg/connect-codebuild.html) | Standard & Express | Standard | _Not supported_ |
| [Amazon DynamoDB](https://docs.aws.amazon.com/step-functions/latest/dg/connect-ddb.html) | Standard & Express | _Not supported_ | _Not supported_ |
| [Amazon ECS/Fargate](https://docs.aws.amazon.com/step-functions/latest/dg/connect-ecs.html) | Standard & Express | Standard | Standard |
| [Amazon EKS](https://docs.aws.amazon.com/step-functions/latest/dg/connect-eks.html) | Standard & Express | Standard | Standard |
| [Amazon EMR](https://docs.aws.amazon.com/step-functions/latest/dg/connect-emr.html) | Standard & Express | Standard | _Not supported_ |
| [Amazon EMR on EKS](https://docs.aws.amazon.com/step-functions/latest/dg/connect-emr-eks.html) | Standard & Express | Standard | _Not supported_ |
| [Amazon EMR Serverless](https://docs.aws.amazon.com/step-functions/latest/dg/connect-emr-serverless.html) | Standard & Express | Standard | _Not supported_ |
| [Amazon EventBridge](https://docs.aws.amazon.com/step-functions/latest/dg/connect-eventbridge.html) | Standard & Express | _Not supported_ | Standard |
| [AWS Glue](https://docs.aws.amazon.com/step-functions/latest/dg/connect-glue.html) | Standard & Express | Standard | _Not supported_ |
| [AWS Glue DataBrew](https://docs.aws.amazon.com/step-functions/latest/dg/connect-databrew.html) | Standard & Express | Standard | _Not supported_ |
| [AWS Lambda](https://docs.aws.amazon.com/step-functions/latest/dg/connect-lambda.html) | Standard & Express | _Not supported_ | Standard |
| [AWS Elemental MediaConvert](https://docs.aws.amazon.com/step-functions/latest/dg/connect-mediaconvert.html) | Standard & Express | Standard | _Not supported_ |
| [Amazon SageMaker AI](https://docs.aws.amazon.com/step-functions/latest/dg/connect-sagemaker.html) | Standard & Express | Standard | _Not supported_ |
| [Amazon SNS](https://docs.aws.amazon.com/step-functions/latest/dg/connect-sns.html) | Standard & Express | _Not supported_ | Standard |
| [Amazon SQS](https://docs.aws.amazon.com/step-functions/latest/dg/connect-sqs.html) | Standard & Express | _Not supported_ | Standard |
| [AWS Step Functions](https://docs.aws.amazon.com/step-functions/latest/dg/connect-stepfunctions.html) | Standard & Express | Standard | Standard |
...
For examples of `Retry` and `Catch`, see [Handling errors in Step Functions workflows](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-error-handling.html).

4. **Human in the loop** – Step Functions can
    include human approval steps in the workflow. For example, imagine a banking
    customer attempts to send funds to a friend. With [a callback and a task token](https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html#connect-wait-token), you can
...
For an example, see [Create a callback pattern example with Amazon SQS, Amazon SNS, and Lambda](https://docs.aws.amazon.com/step-functions/latest/dg/callback-task-sample-sqs.html).
...
Wellarchitected › serverless-applications-lens
[AWS Step Functions Express Workflows![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/similar/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cwellarchitected%7Clatest%7Cserverless-applications-lens%7Cstep-functions-workflows.html)](https://docs.aws.amazon.com/wellarchitected/latest/serverless-applications-lens/step-functions-workflows.html)
...
Step-functions › dg
[Using Amazon States Language to define Step Functions workflows![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/highlyRated/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cconcepts-amazon-states-language.html)](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html)
JSON-based Amazon States Language defines state machines managing Task, Choice, Fail states driving Step Functions workflows.

_June 14, 2026_

Step-functions › dg
[Creating a Step Functions state machine that uses Lambda![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/highlyRated/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Ctutorial-creating-lambda-state-machine.html)](https://docs.aws.amazon.com/step-functions/latest/dg/tutorial-creating-lambda-state-machine.html)
Tutorial creates single-step workflow invoking Lambda via Step Functions, generating ASL definitions using Workflow Studio.

_June 14, 2026_

Step-functions › dg
[Discover service integration patterns in Step Functions![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/highlyRated/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cconnect-to-resource.html)](https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html)
Step Functions integration patterns include Request Response, sync job waiting, callback task tokens, heartbeat timeouts, Context object access.
...
1. [Standard and Express workflows types](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#welcome-workflows)
2. [Integrating with other services](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#welcome-service-integrations)
3. [Example use cases for workflows](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#application)
...
[AWS CLI commands for Step Functions](https://docs.aws.amazon.com/cli/latest/reference/stepfunctions/)
...
[Understand state machines and workflows in Step Functions![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/journey/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cconcepts-statemachines.html)](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-statemachines.html)



[Understand how to get started with AWS Step Functions![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/journey/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cgetting-started.html)](https://docs.aws.amazon.com/step-functions/latest/dg/getting-started.html)



[Understand how EventBridge connects application components![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/journey/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Ceventbridge%7Clatest%7Cuserguide%7Ceb-what-is.html)](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-what-is.html)



[Discover use cases for Step Functions workflows![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/journey/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cuse-cases.html)](https://docs.aws.amazon.com/step-functions/latest/dg/use-cases.html)



[Understand anti-corruption layer pattern for migration![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/journey/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cprescriptive-guidance%7Clatest%7Ccloud-design-patterns%7Cacl.html)](https://docs.aws.amazon.com/prescriptive-guidance/latest/cloud-design-patterns/acl.html)
...
- Recently added to this guide
  ...
  - [Agent setup guide![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/new/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Csfn-agent-setup-guide.html)](https://docs.aws.amazon.com/step-functions/latest/dg/sfn-agent-setup-guide.html)



    _June 10, 2026_

  - [Triage support tickets with Amazon Bedrock AgentCore invokeHarness![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/new/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Csample-bedrock-agentcore-invoke-harness.html)](https://docs.aws.amazon.com/step-functions/latest/dg/sample-bedrock-agentcore-invoke-harness.html)



    _June 3, 2026_

  - [Invoke Amazon Bedrock AgentCore harness with Step Functions![](https://prod.us-west-2.tcx-beacon.docs.aws.dev/recommendation-beacon/new/impressions/null/3aPoZonjpg82FOM1PhGVXKi1lCGwHlNzJS2ALkHt71ErNsj8WYrnZg==/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cwelcome.html/https:%7C%7Cdocs.aws.amazon.com%7Cstep-functions%7Clatest%7Cdg%7Cconnect-bedrockagentcore.html)](https://docs.aws.amazon.com/step-functions/latest/dg/connect-bedrockagentcore.html)
...
[Provide feedback](https://docs.aws.amazon.com/feedback/doc-feedback.html?hidden_service_name=Step+Functions&topic_url=https%3A%2F%2Fdocs.aws.amazon.com%2Fstep-functions%2Flatest%2Fdg%2Fwelcome.html)
...
[Cookie preferences](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html#)
