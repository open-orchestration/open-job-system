...
- [Agents](https://docs.docker.com/ai/sandboxes/agents/)
  ...
  - [Cursor](https://docs.docker.com/ai/sandboxes/agents/cursor/ "Cursor")
  - [Droid](https://docs.docker.com/ai/sandboxes/agents/droid/ "Droid")
  ...
  - [Shell](https://docs.docker.com/ai/sandboxes/agents/shell/ "Shell")
- [Workflows](https://docs.docker.com/ai/sandboxes/workflows/ "Workflows")
- [Customize\\
Early Access](https://docs.docker.com/ai/sandboxes/customize/)



  - [Templates](https://docs.docker.com/ai/sandboxes/customize/templates/ "Templates")
  - [Kits](https://docs.docker.com/ai/sandboxes/customize/kits/ "Kits")
  - [Examples](https://docs.docker.com/ai/sandboxes/customize/kit-examples/ "Examples")
  - [Build an agent](https://docs.docker.com/ai/sandboxes/customize/build-an-agent/ "Build an agent")
...
- [Governance](https://docs.docker.com/ai/sandboxes/governance/)
  ...
  - [Policy concepts](https://docs.docker.com/ai/sandboxes/governance/concepts/ "Policy concepts")
  - [Local policy](https://docs.docker.com/ai/sandboxes/governance/local/ "Local policy")
  - [Org policy](https://docs.docker.com/ai/sandboxes/governance/org/ "Org policy")
  - [Sign-in enforcement](https://docs.docker.com/ai/sandboxes/governance/sign-in-enforcement/ "Sign-in enforcement")
  - [Monitoring policies](https://docs.docker.com/ai/sandboxes/governance/monitoring/ "Monitoring policies")
  - [Audit logs](https://docs.docker.com/ai/sandboxes/governance/audit/ "Audit logs")
  - [API reference](https://docs.docker.com/reference/api/ai-governance/ "API reference")
...
- [Release notes](https://docs.docker.com/ai/sandboxes/release-notes/ "Release notes")
...
- [Usage limits](https://docs.docker.com/ai/gordon/usage-limits/ "Usage limits")
...
- [Explore Docker Desktop](https://docs.docker.com/desktop/use-desktop/)
  ...
  - [Logs](https://docs.docker.com/desktop/use-desktop/logs/ "Logs")
...
- Release notes
  ...
  - [CLI release notes](https://docs.docker.com/dhi/release-notes/cli/ "CLI release notes")
  - [Platform release notes](https://docs.docker.com/dhi/release-notes/platform/ "Platform release notes")
...
- [Compare](https://www.docker.com/pricing?ref=Docs&refAction=DocsSubscriptionDetails "Compare")
- [Setup](https://docs.docker.com/subscription/setup/ "Setup")
- [Upgrade or change](https://docs.docker.com/subscription/change/ "Upgrade or change")
- [Scale](https://docs.docker.com/subscription/scale/ "Scale")
...
- [Organization](https://docs.docker.com/admin/organization/)
...
- [Company](https://docs.docker.com/admin/company/)
  ...
  - [FAQs](https://docs.docker.com/admin/company/company-faqs/ "FAQs")
- [Activity logs](https://docs.docker.com/admin/activity-logs/ "Activity logs")
- [Insights](https://docs.docker.com/admin/insights/ "Insights")
...
- [Add and manage domains](https://docs.docker.com/enterprise/security/domain-management/ "Add and manage domains")
- [Single sign-on](https://docs.docker.com/enterprise/security/single-sign-on/)



  - [Setup](https://docs.docker.com/enterprise/security/single-sign-on/connect/ "Setup")
  - [Manage connections](https://docs.docker.com/enterprise/security/single-sign-on/manage/ "Manage connections")
  - [Troubleshoot](https://docs.docker.com/enterprise/security/single-sign-on/troubleshoot-sso/ "Troubleshoot")
  - FAQs
...
- [Provision](https://docs.docker.com/enterprise/security/provisioning/)
  ...
  - [Auto-provision](https://docs.docker.com/enterprise/security/provisioning/auto-provisioning/ "Auto-provision")
  - [Troubleshoot](https://docs.docker.com/enterprise/security/provisioning/troubleshoot-provisioning/ "Troubleshoot")
...
[Home](https://docs.docker.com/)/ [Manuals](https://docs.docker.com/manuals/)/ [Docker Desktop](https://docs.docker.com/desktop/)/Explore Docker Desktop
...
- [Docker terminal](https://docs.docker.com/desktop/use-desktop/#docker-terminal)
...
- Use
[Gordon](https://docs.docker.com/ai/gordon/), a personal AI assistant embedded in Docker Desktop and the Docker CLI. It's designed to streamline your workflow and help you make the most of the Docker ecosystem.
...
- Navigate to
[Docker Extensions](https://docs.docker.com/extensions/) if you have enabled it.
...
#### [Open the integrated terminal](https://docs.docker.com/desktop/use-desktop/\#open-the-integrated-terminal)
...
[Edit this page](https://github.com/docker/docs/edit/main/content/manuals/desktop/use-desktop/_index.md)

[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fdesktop%2fuse-desktop%2f&labels=status%2Ftriage)
...
[Product offerings](https://www.docker.com/) [Pricing](https://www.docker.com/pricing?ref=Docs&refAction=DocsFooter) [About us](https://www.docker.com/company/) [llms.txt](https://docs.docker.com/llms.txt) [llms-full.txt](https://docs.docker.com/llms-full.txt)
