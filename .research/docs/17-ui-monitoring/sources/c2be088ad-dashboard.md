...
- [Versions](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#)
...
- [English](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#)

  - [中文 (Chinese)](https://kubernetes.io/zh-cn/docs/tasks/access-application-cluster/web-ui-dashboard/)
  - [Français (French)](https://kubernetes.io/fr/docs/tasks/access-application-cluster/web-ui-dashboard/)
  - [Bahasa Indonesia (Indonesian)](https://kubernetes.io/id/docs/tasks/access-application-cluster/web-ui-dashboard/)
  - [日本語 (Japanese)](https://kubernetes.io/ja/docs/tasks/access-application-cluster/web-ui-dashboard/)
  - [한국어 (Korean)](https://kubernetes.io/ko/docs/tasks/access-application-cluster/web-ui-dashboard/)
  - [Português (Portuguese)](https://kubernetes.io/pt-br/docs/tasks/access-application-cluster/web-ui-dashboard/)
  - বাংলা (Bengali)
...
[Edit this page](https://github.com/kubernetes/website/edit/main/content/en/docs/tasks/access-application-cluster/web-ui-dashboard.md) [Create child page](https://github.com/kubernetes/website/new/main/content/en/docs/tasks/access-application-cluster/web-ui-dashboard.md?filename=change-me.md&value=---%0Atitle%3A+%22Long+Page+Title%22%0AlinkTitle%3A+%22Short+Nav+Title%22%0Aweight%3A+100%0Adescription%3A+%3E-%0A+++++Page+description+for+heading+and+indexes.%0A---%0A%0A%23%23+Heading%0A%0AEdit+this+template+to+create+your+new+page.%0A%0A%2A+Give+it+a+good+name%2C+ending+in+%60.md%60+-+e.g.+%60getting-started.md%60%0A%2A+Edit+the+%22front+matter%22+section+at+the+top+of+the+page+%28weight+controls+how+its+ordered+amongst+other+pages+in+the+same+directory%3B+lowest+number+first%29.%0A%2A+Add+a+good+commit+message+at+the+bottom+of+the+page+%28%3C80+characters%3B+use+the+extended+description+field+for+more+detail%29.%0A%2A+Create+a+new+branch+so+you+can+preview+your+new+file+and+request+a+review+via+Pull+Request.%0A) [Create an issue](https://github.com/kubernetes/website/issues/new?title=Deploy%20and%20Access%20the%20Kubernetes%20Dashboard) [Print entire section](https://kubernetes.io/docs/tasks/access-application-cluster/_print/)
...
- [Welcome view](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#welcome-view)
- [Deploying containerized applications](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#deploying-containerized-applications)
  - [Specifying application details](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#specifying-application-details)
  - [Uploading a YAML or JSON file](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#uploading-a-yaml-or-json-file)
- [Using Dashboard](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#using-dashboard)
  - [Navigation](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#navigation)
- [What's next](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/#what-s-next)

1. [Kubernetes Documentation](https://kubernetes.io/docs/)
2. [Tasks](https://kubernetes.io/docs/tasks/)
3. [Access Applications in a Cluster](https://kubernetes.io/docs/tasks/access-application-cluster/)
...
![Kubernetes Dashboard UI](https://kubernetes.io/images/docs/ui-dashboard.png)

## Deploying the Dashboard UI [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#deploying-the-dashboard-ui)
...
## Accessing the Dashboard UI [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#accessing-the-dashboard-ui)
...
### Command line proxy [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#command-line-proxy)
...
## Welcome view [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#welcome-view)
...
In addition, you can view which system applications are running by default in the `kube-system` [namespace](https://kubernetes.io/docs/tasks/administer-cluster/namespaces/) of your cluster, for example the Dashboard itself.

![Kubernetes Dashboard welcome page](https://kubernetes.io/images/docs/ui-dashboard-zerostate.png)

## Deploying containerized applications [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#deploying-containerized-applications)
...
### Specifying application details [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#specifying-application-details)

The deploy wizard expects that you provide the following information:

- **App name** (mandatory): Name for your application.
A [label](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/) with the name will be
added to the Deployment and Service, if any, that will be deployed.

The application name must be unique within the selected Kubernetes [namespace](https://kubernetes.io/docs/tasks/administer-cluster/namespaces/).
...
The URL of a public Docker [container image](https://kubernetes.io/docs/concepts/containers/images/) on any registry,
...
A [Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) will be created to
...
[Service](https://kubernetes.io/docs/concepts/services-networking/service/) onto an external,
...
- **Labels**: Default [labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/) to be used
...
These virtual clusters are called [namespaces](https://kubernetes.io/docs/tasks/administer-cluster/namespaces/).
...
[pull secret](https://kubernetes.io/docs/concepts/configuration/secret/) credentials.
...
[`.dockercfg`](https://kubernetes.io/docs/concepts/containers/images/#specifying-imagepullsecrets-on-a-pod) file.
...
You can specify the minimum [resource limits](https://kubernetes.io/docs/tasks/administer-cluster/manage-resources/memory-default-namespace/)
...
[entrypoint command](https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/).
...
[privileged containers](https://kubernetes.io/docs/concepts/workloads/pods/#privileged-mode-for-containers)
...
### Uploading a YAML or JSON file [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#uploading-a-yaml-or-json-file)
...
The manifests use Kubernetes [API](https://kubernetes.io/docs/concepts/overview/kubernetes-api/) resource schemas.
...
## Using Dashboard [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#using-dashboard)

Following sections describe views of the Kubernetes Dashboard UI; what they provide and how can they be used.

### Navigation [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#navigation)
...
#### Admin overview [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#admin-overview)
...
#### Workloads [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#workloads)
...
#### Services [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#services)
...
#### Storage [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#storage)

Storage view shows PersistentVolumeClaim resources which are used by applications for storing data.

#### ConfigMaps and Secrets [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#config-maps-and-secrets)
...
#### Logs viewer [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#logs-viewer)
...
## What's next [Heading self-link](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/\#what-s-next)
...
[report a problem](https://github.com/kubernetes/website/issues/new?title=Issue%20with%20k8s.io/docs/tasks/access-application-cluster/web-ui-dashboard/)
or
[suggest an improvement](https://github.com/kubernetes/website/issues/new?title=Improvement%20for%20k8s.io/docs/tasks/access-application-cluster/web-ui-dashboard/).
...
- [한국어 (Korean)](https://kubernetes.io/ko/docs/tasks/access-application-cluster/web-ui-dashboard/)
- [Português (Portuguese)](https://kubernetes.io/pt-br/docs/tasks/access-application-cluster/web-ui-dashboard/)
- [Light](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/)
- [Dark](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/)
- [Auto](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/)