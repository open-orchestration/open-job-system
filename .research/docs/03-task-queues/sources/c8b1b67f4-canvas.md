...
- [next](https://docs.celeryq.dev/en/stable/userguide/workers.html "Workers Guide") \|
- [previous](https://docs.celeryq.dev/en/stable/userguide/calling.html "Calling Tasks") \|
...
# Canvas: Designing Work-flows [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#canvas-designing-work-flows "Link to this heading")

- [Signatures](https://docs.celeryq.dev/en/stable/userguide/canvas.html#signatures)

  - [Partials](https://docs.celeryq.dev/en/stable/userguide/canvas.html#partials)

  - [Immutability](https://docs.celeryq.dev/en/stable/userguide/canvas.html#immutability)

  - [Callbacks](https://docs.celeryq.dev/en/stable/userguide/canvas.html#callbacks)
- [The Primitives](https://docs.celeryq.dev/en/stable/userguide/canvas.html#the-primitives)

  - [Chains](https://docs.celeryq.dev/en/stable/userguide/canvas.html#chains)

  - [Groups](https://docs.celeryq.dev/en/stable/userguide/canvas.html#groups)

  - [Chords](https://docs.celeryq.dev/en/stable/userguide/canvas.html#chords)

  - [Map & Starmap](https://docs.celeryq.dev/en/stable/userguide/canvas.html#map-starmap)

  - [Chunks](https://docs.celeryq.dev/en/stable/userguide/canvas.html#chunks)
- [Stamping](https://docs.celeryq.dev/en/stable/userguide/canvas.html#stamping)

  - [Canvas stamping](https://docs.celeryq.dev/en/stable/userguide/canvas.html#id3)

  - [Custom stamping](https://docs.celeryq.dev/en/stable/userguide/canvas.html#custom-stamping)

  - [Callbacks stamping](https://docs.celeryq.dev/en/stable/userguide/canvas.html#callbacks-stamping)

## [Signatures](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id4) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#signatures "Link to this heading")

Added in version 2.0.

You just learned how to call a task using the tasks `delay` method
in the [calling](https://docs.celeryq.dev/en/stable/userguide/calling.html#guide-calling) guide, and this is often all you need,
...
A [`signature()`](https://docs.celeryq.dev/en/stable/reference/celery.html#celery.signature "celery.signature") wraps the arguments, keyword arguments, and execution options
...
> [`app.Task.apply_async()`](https://docs.celeryq.dev/en/stable/reference/celery.app.task.html#celery.app.task.Task.apply_async "celery.app.task.Task.apply_async") method:
>
> ```
...
- You can’t define options with [`s()`](https://docs.celeryq.dev/en/stable/reference/celery.app.task.html#celery.app.task.Task.s "celery.app.task.Task.s"), but a chaining
...
### [Partials](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id5) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#partials "Link to this heading")
...
### [Immutability](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id6) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#immutability "Link to this heading")
...
### [Callbacks](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id7) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#callbacks "Link to this heading")
...
As expected this will first launch one task calculating ![2 + 2](https://docs.celeryq.dev/en/stable/_images/math/3c92a196461843c26825eb716980c76c131d3cfd.png), then
another task calculating ![4 + 8](https://docs.celeryq.dev/en/stable/_images/math/71761d65f6fe91dc46537e1d388b51ba92e9e5bc.png).

## [The Primitives](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id8) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#the-primitives "Link to this heading")
...
> after the other, essentially forming a _chain_ of callbacks.
...
> required for algorithms that aren’t _embarrassingly parallel_:
>
> ```
...
resource issues. The _pickle_ serializer is not vulnerable to this and may
therefore be preferable in such cases.

### [Chains](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id9) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#chains "Link to this heading")
...
The result instance also has a [`collect()`](https://docs.celeryq.dev/en/stable/reference/celery.result.html#celery.result.AsyncResult.collect "celery.result.AsyncResult.collect") method
...
By default [`collect()`](https://docs.celeryq.dev/en/stable/reference/celery.result.html#celery.result.AsyncResult.collect "celery.result.AsyncResult.collect") will raise an
[`IncompleteStream`](https://docs.celeryq.dev/en/stable/reference/celery.exceptions.html#celery.exceptions.IncompleteStream "celery.exceptions.IncompleteStream") exception if the graph isn’t fully
...
a special signature called [`chain`](https://docs.celeryq.dev/en/stable/reference/celery.html#celery.chain "celery.chain") that lets
...
#### Task ID [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#task-id "Link to this heading")

Added in version 5.4.

A chain will inherit the task id of the last task in the chain.

#### Graphs [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#graphs "Link to this heading")

In addition you can work with the result graph as a
[`DependencyGraph`](https://docs.celeryq.dev/en/stable/internals/reference/celery.utils.graph.html#celery.utils.graph.DependencyGraph "celery.utils.graph.DependencyGraph"):
...
### [Groups](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id10) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#groups "Link to this heading")

Added in version 3.0.

Note

Similarly to chords, tasks used in a group must _not_ ignore their results.
See “ [Important Notes](https://docs.celeryq.dev/en/stable/userguide/canvas.html#chord-important-notes)” for more information.
...
one after another in the current process, and a [`GroupResult`](https://docs.celeryq.dev/en/stable/reference/celery.result.html#celery.result.GroupResult "celery.result.GroupResult")
...
#### Group Callbacks and Error Handling [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#group-callbacks-and-error-handling "Link to this heading")
...
Additionally, linking the task will _not_ guarantee that it will activate only
...
These use cases are better addressed by the [`chord`](https://docs.celeryq.dev/en/stable/reference/celery.html#celery.chord "celery.chord") class which
is supported on certain backend implementations.

#### Group Results [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#group-results "Link to this heading")
...
The [`GroupResult`](https://docs.celeryq.dev/en/stable/reference/celery.result.html#celery.result.GroupResult "celery.result.GroupResult") takes a list of
[`AsyncResult`](https://docs.celeryq.dev/en/stable/reference/celery.result.html#celery.result.AsyncResult "celery.result.AsyncResult") instances and operates on them as
...
#### Group Unrolling [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#group-unrolling "Link to this heading")
...
### [Chords](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id11) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#chords "Link to this heading")

Added in version 2.3.

Note

Tasks used within a chord must _not_ ignore their results. If the result
backend is disabled for _any_ task (header or body) in your chord you
should read “ [Important Notes](https://docs.celeryq.dev/en/stable/userguide/canvas.html#chord-important-notes)”. Chords are not currently
...
![1 + 1 + 2 + 2 + 3 + 3 ... n + n](https://docs.celeryq.dev/en/stable/_images/math/e0abf23a503127a1d8599dafa280120f05847d71.png) up to a hundred digits.
...
for other tasks](https://docs.celeryq.dev/en/stable/userguide/tasks.html#task-synchronous-subtasks))

#### Error handling [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#error-handling "Link to this heading")
...
to the [`ChordError`](https://docs.celeryq.dev/en/stable/reference/celery.exceptions.html#celery.exceptions.ChordError "celery.exceptions.ChordError") exception:
...
Also the [`ChordError`](https://docs.celeryq.dev/en/stable/reference/celery.exceptions.html#celery.exceptions.ChordError "celery.exceptions.ChordError") only shows the task that failed
...
Enabling this flag will cause the chord header to invoke the errback for the body (default behavior) _and_ any task in the chord’s header that fails.

#### Important Notes [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#important-notes "Link to this heading")

Tasks used within a chord must _not_ ignore their results. In practice this
...
### [Map & Starmap](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id12) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#map-starmap "Link to this heading")
...
### [Chunks](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id13) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#chunks "Link to this heading")
...
As with [`group`](https://docs.celeryq.dev/en/stable/reference/celery.html#celery.group "celery.group") the act of sending the messages for
...
## [Stamping](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id14) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#stamping "Link to this heading")
...
For this feature to be useful, you need to set the [`result_extended`](https://docs.celeryq.dev/en/stable/userguide/configuration.html#std-setting-result_extended)
configuration option to `True` or directive `result_extended = True`.

### [Canvas stamping](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id15) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id3 "Link to this heading")
...
### [Custom stamping](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id16) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#custom-stamping "Link to this heading")
...
### [Callbacks stamping](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#id17) [¶](https://docs.celeryq.dev/en/stable/userguide/canvas.html\#callbacks-stamping "Link to this heading")
...
[Calling Tasks](https://docs.celeryq.dev/en/stable/userguide/calling.html "previous chapter")

#### Next topic

[Workers Guide](https://docs.celeryq.dev/en/stable/userguide/workers.html "next chapter")

### This Page

- [Show Source](https://docs.celeryq.dev/en/stable/_sources/userguide/canvas.rst.txt)
...
Versions[latest](https://docs.celeryq.dev/en/latest/userguide/canvas.html)**[stable](https://docs.celeryq.dev/en/stable/userguide/canvas.html)**[v5.6.3](https://docs.celeryq.dev/en/v5.6.3/userguide/canvas.html)[v5.6.2](https://docs.celeryq.dev/en/v5.6.2/userguide/canvas.html)[v5.6.1](https://docs.celeryq.dev/en/v5.6.1/userguide/canvas.html)[v5.6.0](https://docs.celeryq.dev/en/v5.6.0/userguide/canvas.html)[v5.5.3](https://docs.celeryq.dev/en/v5.5.3/userguide/canvas.html)[v5.5.2](https://docs.celeryq.dev/en/v5.5.2/userguide/canvas.html)[v5.5.1](https://docs.celeryq.dev/en/v5.5.1/userguide/canvas.html)[v5.5.0](https://docs.celeryq.dev/en/v5.5.0/userguide/canvas.html)[v5.4.0](https://docs.celeryq.dev/en/v5.4.0/userguide/canvas.html)[v5.3.6](https://docs.celeryq.dev/en/v5.3.6/userguide/canvas.html)[v5.3.5](https://docs.celeryq.dev/en/v5.3.5/userguide/canvas.html)[v5.3.4](https://docs.celeryq.dev/en/v5.3.4/userguide/canvas.html)[v5.3.3](https://docs.celeryq.dev/en/v5.3.3/userguide/canvas.html)[v5.3.2](https://docs.celeryq.dev/en/v5.3.2/userguide/canvas.html)[v5.3.1](https://docs.celeryq.dev/en/v5.3.1/userguide/canvas.html)[v5.3.0](https://docs.celeryq.dev/en/v5.3.0/userguide/canvas.html)[v5.2.7](https://docs.celeryq.dev/en/v5.2.7/userguide/canvas.html)[v5.2.6](https://docs.celeryq.dev/en/v5.2.6/userguide/canvas.html)[v5.2.5](https://docs.celeryq.dev/en/v5.2.5/userguide/canvas.html)[v5.2.4](https://docs.celeryq.dev/en/v5.2.4/userguide/canvas.html)[v5.2.3](https://docs.celeryq.dev/en/v5.2.3/userguide/canvas.html)[v5.2.2](https://docs.celeryq.dev/en/v5.2.2/userguide/canvas.html)[v5.2.1](https://docs.celeryq.dev/en/v5.2.1/userguide/canvas.html)[v5.2.0](https://docs.celeryq.dev/en/v5.2.0/userguide/canvas.html)[v5.1.2](https://docs.celeryq.dev/en/v5.1.2/userguide/canvas.html)[v5.1.1](https://docs.celeryq.dev/en/v5.1.1/userguide/canvas.html)[v5.1.0](https://docs.celeryq.dev/en/v5.1.0/userguide/canvas.html)[v5.0.5](https://docs.celeryq.dev/en/v5.0.5/userguide/canvas.html)[v5.0.2](https://docs.celeryq.dev/en/v5.0.2/userguide/canvas.html)[v5.0.1](https://docs.celeryq.dev/en/v5.0.1/userguide/canvas.html)[v5.0.0](https://docs.celeryq.dev/en/v5.0.0/userguide/canvas.html)[v4.4.7](https://docs.celeryq.dev/en/v4.4.7/userguide/canvas.html)[v4.4.6](https://docs.celeryq.dev/en/v4.4.6/userguide/canvas.html)[v4.4.5](https://docs.celeryq.dev/en/v4.4.5/userguide/canvas.html)[v4.4.4](https://docs.celeryq.dev/en/v4.4.4/userguide/canvas.html)[4.4.3](https://docs.celeryq.dev/en/4.4.3/userguide/canvas.html)[4.4.2](https://docs.celeryq.dev/en/4.4.2/userguide/canvas.html)[4.4.1](https://docs.celeryq.dev/en/4.4.1/userguide/canvas.html)[4.4.0](https://docs.celeryq.dev/en/4.4.0/userguide/canvas.html)[v4.3.0](https://docs.celeryq.dev/en/v4.3.0/userguide/canvas.html)[v4.2.2](https://docs.celeryq.dev/en/v4.2.2/userguide/canvas.html)[v4.2.1](https://docs.celeryq.dev/en/v4.2.1/userguide/canvas.html)[v4.2.0](https://docs.celeryq.dev/en/v4.2.0/userguide/canvas.html)[v4.1.0](https://docs.celeryq.dev/en/v4.1.0/userguide/canvas.html)[v4.0.2](https://docs.celeryq.dev/en/v4.0.2/userguide/canvas.html)[v4.0.1](https://docs.celeryq.dev/en/v4.0.1/userguide/canvas.html)[v4.0.0](https://docs.celeryq.dev/en/v4.0.0/userguide/canvas.html)[4.0](https://docs.celeryq.dev/en/4.0/userguide/canvas.html)[3.1](https://docs.celeryq.dev/en/3.1/userguide/canvas.html)[3.0](https://docs.celeryq.dev/en/3.0/userguide/canvas.html)[main](https://docs.celeryq.dev/en/main/userguide/canvas.html)[2.5-archived](https://docs.celeryq.dev/en/2.5-archived/userguide/canvas.html)[2.4-archived](https://docs.celeryq.dev/en/2.4-archived/userguide/canvas.html)[2.3-archived](https://docs.celeryq.dev/en/2.3-archived/userguide/canvas.html)[2.2-archived](https://docs.celeryq.dev/en/2.2-archived/userguide/canvas.html)[2.1-archived](https://docs.celeryq.dev/en/2.1-archived/userguide/canvas.html)[2.0-archived](https://docs.celeryq.dev/en/2.0-archived/userguide/canvas.html)[1.0-archived](https://docs.celeryq.dev/en/1.0-archived/userguide/canvas.html)On Read the Docs[Project Home](https://app.readthedocs.org/projects/celery/?utm_source=celery&utm_content=flyout)[Builds](https://app.readthedocs.org/projects/celery/builds/?utm_source=celery&utm_content=flyout)Search
