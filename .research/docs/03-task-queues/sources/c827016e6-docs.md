[![Fork me on GitHub](https://github.blog/wp-content/uploads/2008/12/forkme_right_red_aa0000.png)](http://git.io/rq)

- [Home](https://python-rq.org/)
- [Docs](https://python-rq.org/docs/)
- [Patterns](https://python-rq.org/patterns/)
- [Contributing](https://python-rq.org/contrib/)
- [Chat](https://python-rq.org/chat/)

- [Queues](https://python-rq.org/docs/)
- [Workers](https://python-rq.org/docs/workers/)
- [Results](https://python-rq.org/docs/results/)
- [Jobs](https://python-rq.org/docs/jobs/)
- [Exceptions & Retries](https://python-rq.org/docs/exceptions/)
- [Scheduling & Repeating Jobs](https://python-rq.org/docs/scheduling/)
- [Cron Style Scheduling](https://python-rq.org/docs/cron/)
- [Job Registries](https://python-rq.org/docs/job_registries/)
- [Monitoring](https://python-rq.org/docs/monitoring/)
- [Connections](https://python-rq.org/docs/connections/)
...
## Enqueueing Jobs [Anchor](https://python-rq.org/docs/\#enqueueing-jobs)
...
- `at_front` will place the job at the _front_ of the queue, instead of the
  back
...
- `unique`: when set to `True`, prevents duplicate jobs with the same `job_id` from being enqueued.
  See [Unique Jobs](https://python-rq.org/docs/#unique-jobs) below.
...
### Bulk Job Enqueueing [Anchor](https://python-rq.org/docs/\#bulk-job-enqueueing)
...
### Grouping jobs [Anchor](https://python-rq.org/docs/\#grouping-jobs)
...
### Unique Jobs [Anchor](https://python-rq.org/docs/\#unique-jobs)
...
## Job dependencies [Anchor](https://python-rq.org/docs/\#job-dependencies)
...
its dependency finishes _successfully_.
...
## Job Callbacks [Anchor](https://python-rq.org/docs/\#job-callbacks)
...
### Callback Class and Callback Timeouts [Anchor](https://python-rq.org/docs/\#callback-class-and-callback-timeouts)
...
### Success Callback [Anchor](https://python-rq.org/docs/\#success-callback)
...
### Failure Callbacks [Anchor](https://python-rq.org/docs/\#failure-callbacks)

Failure callbacks are functions that accept `job`, `connection`, `type`, `value` and `traceback`
arguments. `type`, `value` and `traceback` values returned by [sys.exc\_info()](https://docs.python.org/3/library/sys.html#sys.exc_info), which is the exception raised when executing your job.
...
### Stopped Callbacks [Anchor](https://python-rq.org/docs/\#stopped-callbacks)
...
### CLI Enqueueing [Anchor](https://python-rq.org/docs/\#cli-enqueueing)
...
#### Usage: [Anchor](https://python-rq.org/docs/\#usage)

```
rq enqueue [OPTIONS] FUNCTION [ARGUMENTS]
```

#### Options: [Anchor](https://python-rq.org/docs/\#options)
...
#### Function: [Anchor](https://python-rq.org/docs/\#function)
...
#### Arguments: [Anchor](https://python-rq.org/docs/\#arguments)
...
##### Examples: [Anchor](https://python-rq.org/docs/\#examples)
...
## Working with Queues [Anchor](https://python-rq.org/docs/\#working-with-queues)
...
### On the Design [Anchor](https://python-rq.org/docs/\#on-the-design)
...
Lastly, it does not speak a portable protocol, since it depends on [pickle](http://docs.python.org/library/pickle.html)
to serialize the jobs, so it’s a Python-only system.

## The delayed result [Anchor](https://python-rq.org/docs/\#the-delayed-result)
...
## The `@job` decorator [Anchor](https://python-rq.org/docs/\#the-job-decorator)
...
## Bypassing workers [Anchor](https://python-rq.org/docs/\#bypassing-workers)
...
## The worker [Anchor](https://python-rq.org/docs/\#the-worker)

To learn about workers, see the [workers](https://python-rq.org/docs/workers/) documentation.

## Suspending and Resuming [Anchor](https://python-rq.org/docs/\#suspending-and-resuming)
...
## Considerations for jobs [Anchor](https://python-rq.org/docs/\#considerations-for-jobs)
...
## Limitations [Anchor](https://python-rq.org/docs/\#limitations)
...
RQ is maintained by [Stamps](https://stamps.id/), an Indonesian CRM company.


It is open sourced under the terms of the [BSD license](https://raw.github.com/nvie/rq/master/LICENSE).