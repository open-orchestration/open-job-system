# User Guide [¶](https://dramatiq.io/guide.html\#user-guide "Link to this heading")

To follow along with this guide you’ll need to install and run [RabbitMQ](https://www.rabbitmq.com/)
and then set up a new [virtual environment](http://docs.python-guide.org/en/latest/starting/install3/osx/#virtual-environments) in which you’ll have
to install Dramatiq and [Requests](http://docs.python-requests.org/):
...
count\_words.py [¶](https://dramatiq.io/guide.html#id3 "Link to this code")
...
using Dramatiq, all we have to do is decorate it with [`actor`](https://dramatiq.io/reference.html#dramatiq.actor "dramatiq.actor"):

count\_words.py [¶](https://dramatiq.io/guide.html#id4 "Link to this code")
...
asynchronously by calling its [`send`](https://dramatiq.io/reference.html#dramatiq.Actor.send "dramatiq.Actor.send") method:
...
server) that can be processed asynchronously but _doesn’t actually run_
_the function_. In order to run it, we’ll have to boot up a Dramatiq
worker.
...
[`actor`](https://dramatiq.io/reference.html#dramatiq.actor "dramatiq.actor"):
...
longer than 10 minutes is killed with a [`TimeLimitExceeded`](https://dramatiq.io/reference.html#dramatiq.middleware.TimeLimitExceeded "dramatiq.middleware.TimeLimitExceeded") error.
...
wrap its source code in a try block and catch [`TimeLimitExceeded`](https://dramatiq.io/reference.html#dramatiq.middleware.TimeLimitExceeded "dramatiq.middleware.TimeLimitExceeded"):
...
[`send_with_options`](https://dramatiq.io/reference.html#dramatiq.Actor.send_with_options "dramatiq.Actor.send_with_options") on actors and providing a `delay` (in
milliseconds):
...
Keep in mind that _your message broker is not a database_. Scheduled
...
This only happens _after_ messages are consumed from the queues.
...
one of them, `generate_report` will always run _first_.
...
The [`RabbitmqBroker`](https://dramatiq.io/reference.html#dramatiq.brokers.rabbitmq.RabbitmqBroker "dramatiq.brokers.rabbitmq.RabbitmqBroker") supports prioritizing messages while they are waiting in the queue
...
To configure the RabbitMQ host, instantiate a [`RabbitmqBroker`](https://dramatiq.io/reference.html#dramatiq.brokers.rabbitmq.RabbitmqBroker "dramatiq.brokers.rabbitmq.RabbitmqBroker") and set
...
Dramatiq provides a [`StubBroker`](https://dramatiq.io/reference.html#dramatiq.brokers.stub.StubBroker "dramatiq.brokers.stub.StubBroker") that can be used in unit tests so you
...
in your main thread when you call its [`StubBroker.join`](https://dramatiq.io/reference.html#dramatiq.brokers.stub.StubBroker.join "dramatiq.brokers.stub.StubBroker.join") method:
...
[![](https://dramatiq.io/_static/logo.png)](https://dramatiq.io/index.html)

Star Bogdanp/dramatiq on GitHub[Star](https://github.com/Bogdanp/dramatiq) [5,268](https://github.com/Bogdanp/dramatiq/stargazers)

### Navigation

- [Installation](https://dramatiq.io/installation.html)
- [Motivation](https://dramatiq.io/motivation.html)
- [User Guide](https://dramatiq.io/guide.html#)
  - [Actors](https://dramatiq.io/guide.html#actors)
  - [Workers](https://dramatiq.io/guide.html#workers)
  - [Error Handling](https://dramatiq.io/guide.html#error-handling)
  - [Code Reloading](https://dramatiq.io/guide.html#code-reloading)
  - [Message Retries](https://dramatiq.io/guide.html#message-retries)
  - [Message Age Limits](https://dramatiq.io/guide.html#message-age-limits)
  - [Message Time Limits](https://dramatiq.io/guide.html#message-time-limits)
  - [Scheduling Messages](https://dramatiq.io/guide.html#scheduling-messages)
  - [Prioritizing Messages](https://dramatiq.io/guide.html#prioritizing-messages)
  - [Message Brokers](https://dramatiq.io/guide.html#message-brokers)
  - [Unit Testing](https://dramatiq.io/guide.html#unit-testing)
- [Best Practices](https://dramatiq.io/best_practices.html)
- [Troubleshooting](https://dramatiq.io/troubleshooting.html)
- [Advanced Topics](https://dramatiq.io/advanced.html)
- [Cookbook](https://dramatiq.io/cookbook.html)
...
- [Project License](https://dramatiq.io/license.html)

### Quick search

### Sponsors

[![](https://dramatiq.io/_static/franz-logo.png)\\
Franz — Desktop Client for Apache Kafka](https://franz.defn.io/)

[![](https://dramatiq.io/_static/podcatcher-logo.png)\\
Podcatcher — iOS Podcast Player](https://podcatcher.defn.io/)

©2017, 2018, 2019 CLEARTYPE SRL.

\|
Powered by [Sphinx 8.1.3](https://www.sphinx-doc.org/)
& [Alabaster 1.0.0](https://alabaster.readthedocs.io/)

\|
[Page source](https://dramatiq.io/_sources/guide.rst.txt)