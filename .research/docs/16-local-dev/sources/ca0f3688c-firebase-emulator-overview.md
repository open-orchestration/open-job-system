[Skip to main content](https://firebase.google.com/docs/emulator-suite#main-content)

[![Firebase](https://www.gstatic.com/devrel-devsite/prod/v20cdb2337f656fc22df509b6d5402b3836a1b55334a8eea3301423a87970c4d5/firebase/images/lockup.svg)](https://firebase.google.com/)
...
- [English](https://firebase.google.com/docs/emulator-suite)
- [Deutsch](https://firebase.google.com/docs/emulator-suite?hl=de)
- [Español – América Latina](https://firebase.google.com/docs/emulator-suite?hl=es-419)
- [Français](https://firebase.google.com/docs/emulator-suite?hl=fr)
- [Indonesia](https://firebase.google.com/docs/emulator-suite?hl=id)
- [Italiano](https://firebase.google.com/docs/emulator-suite?hl=it)
- [Polski](https://firebase.google.com/docs/emulator-suite?hl=pl)
- [Português – Brasil](https://firebase.google.com/docs/emulator-suite?hl=pt-br)
- [Tiếng Việt](https://firebase.google.com/docs/emulator-suite?hl=vi)
- [Türkçe](https://firebase.google.com/docs/emulator-suite?hl=tr)
- [Русский](https://firebase.google.com/docs/emulator-suite?hl=ru)
- [עברית](https://firebase.google.com/docs/emulator-suite?hl=he)
- [العربيّة](https://firebase.google.com/docs/emulator-suite?hl=ar)
- [فارسی](https://firebase.google.com/docs/emulator-suite?hl=fa)
- [हिंदी](https://firebase.google.com/docs/emulator-suite?hl=hi)
- [বাংলা](https://firebase.google.com/docs/emulator-suite?hl=bn)
- [ภาษาไทย](https://firebase.google.com/docs/emulator-suite?hl=th)
- [中文 – 简体](https://firebase.google.com/docs/emulator-suite?hl=zh-cn)
- [中文 – 繁體](https://firebase.google.com/docs/emulator-suite?hl=zh-tw)
- [日本語](https://firebase.google.com/docs/emulator-suite?hl=ja)
- [한국어](https://firebase.google.com/docs/emulator-suite?hl=ko)

[Blog](https://firebase.blog/) [Go to console](https://console.firebase.google.com/)

[Sign in](https://firebase.google.com/_d/signin?continue=https%3A%2F%2Ffirebase.google.com%2Fdocs%2Femulator-suite&prompt=select_account)
...
- On this page
- [Before you begin](https://firebase.google.com/docs/emulator-suite#before_you_begin)
- [What is Firebase Local Emulator Suite?](https://firebase.google.com/docs/emulator-suite#what-is-emulator-suite)
  - [Emulator Suite in your local workflows](https://firebase.google.com/docs/emulator-suite#emulator_suite_in_your_local_workflows)
  - [Which Firebase features and platforms are supported?](https://firebase.google.com/docs/emulator-suite#feature-matrix)
- [Next steps](https://firebase.google.com/docs/emulator-suite#next_steps)
- [Other tools for prototyping and testing](https://firebase.google.com/docs/emulator-suite#other_tools_for_prototyping_and_testing)
...
# Introduction to Firebase Local Emulator Suite    Stay organized with collections      Save and categorize content based on your preferences.
...
![Adding Firebase Emulator Suite to your development workflows.](https://firebase.google.com/docs/emulator-suite/images/emulator-suite-usecase.png)
...
- Read the **Get started with Firebase** topics for your platform and products
( [Apple](https://firebase.google.com/docs/ios/setup), [Android](https://firebase.google.com/docs/android/setup) or [Web](https://firebase.google.com/docs/web/setup)).
- Download a ready-to-run quickstart app on your platform of choice, then read
through and execute the code. The FriendlyEats quickstart app is a good choice
( [iOS](https://github.com/firebase/friendlyeats-ios), [Android](https://github.com/firebase/friendlyeats-android) or [Web](https://github.com/firebase/friendlyeats-web)).
...
**Note:** Do not attempt to use these emulators as "self-hosted" versions of
Firebase services. They are built for accuracy, not performance or security,
and are not appropriate to use in production.
...
- **Unit Tests**: using the Firebase Test SDK, you can write unit tests in
...
simple tests for database interactions that don't depend on your app's logic.
- **Integration Tests**: each individual product emulator in the Emulator
...
- **Manual Tests**: you can connect your running application to the
Local Emulator Suite to test your Firebase app manually, without risking
production data or configuring a test project.
- **Product Evaluations**: you can install and manage Firebase Extensions
...
|  | **Cloud**<br>**Firestore** | **Realtime**<br>**Database** | **Cloud**<br>**Storage**<br>**for Firebase** | **Authentication** | **Cloud**<br>**Functions** | **Cloud**<br>**Pub/Sub** | **Extensions** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **Android SDK** |  |  |  |  |  | N/A | N/A |
| **iOS SDK** |  |  |  |  |  | N/A | N/A |
| **Web SDK** |  |  |  |  |  | N/A | N/A |
...
- The Cloud Functions emulator, part of the Emulator Suite. This emulator is
interoperable with local, live data and Security Rules in the Firestore
emulator and/or Realtime Database emulator.
- The Cloud Functions shell, which allows for interactive, iterative functions
...
Cloud Firestore or Realtime Database emulators is provided. Using the shell, you
mock data and perform function calls to simulate interaction with products that
the Local Emulator Suite does not currently support: Analytics,
Remote Config, and Crashlytics.
- The Firebase Test SDK for Cloud Functions, a Node.js with mocha framework
for functions development. In effect, the Cloud Functions Test SDK provides
automation atop the Cloud Functions shell.
...
- The Rules Playground, a part of the Firebase console. The
...
[Quickly validate Firebase Security Rules](https://firebase.google.com/docs/rules/simulator).
...
[![Google Developers](https://www.gstatic.com/devrel-devsite/prod/v20cdb2337f656fc22df509b6d5402b3836a1b55334a8eea3301423a87970c4d5/firebase/images/lockup-google-for-developers.svg)](https://developers.google.com/)
...
- [Manage cookies](https://firebase.google.com/docs/emulator-suite#)
